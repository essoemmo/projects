...
class OfflineDataTable extends DataTable
{
    /**
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ...
            ->addColumn('delete', 'admin.transaction.offline.btn.delete')
            ->rawColumns([
                'user',
                 'bank',
                 'delete',
    ...
    public function query()
    {
        return Transaction::query()->orderByDesc('id')
            ->where('bank_id' ,"!=", null)->where('store_id' , Utility::getStoreId());
    }
...
//                "language" =>  self::lang(),
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name'=>'bank','data'=>'bank','title'=> _i('bank')],
