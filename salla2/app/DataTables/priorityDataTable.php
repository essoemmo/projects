...
class priorityDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function($query){
                return '<a href="priority/'.$query->id.'/edit" class="btn btn-success"><i class="ti-pencil-alt"></i> edit</a>';
            })
     ...
     */
    public function query(ticketPriorities $priority)
    {
    ...
    public function html()
    {
        return $this->builder()
                    ...
                    ->parameters([
                        ...
                        'buttons' => [
                            [
                                'text' => '<i class="ti-plus"></i> create new priority',
                                'className' => 'btn btn-primary create',
                                'action' => 'function( e, dt, button, config){ 
                                         window.location = "priority/create";
                                     }',
                            ],
