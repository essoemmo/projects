...
class ArticleCategoryController extends Controller
{
    ...
    public function index(BlogsCatDataTable $artcl_categories)
    {
        return $artcl_categories->render('admin.article_management.category.index');
    }

    public function create()
    {
        $langs = Language::get();
        return view('admin.article_management.category.create', compact('langs'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('admin.article_management.category.edit', compact('langs', 'article_cat', 'article_cat_data'));
    }
    ...
    public function get_categories(Request $request)
    {
        ...
        $query = ArticleCategory::leftJoin('article_category_data', 'article_category_data.category_id', 'article_category.id')
            ...
            ->where('article_category_data.lang_id', $request->lang_id)
            ->where('article_category.store_id', Utility::getStoreId())
