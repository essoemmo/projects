...
class ArticlesController extends Controller
{
    ...
    public function index(BlogsDataTable $articles)
    {
        return $articles->render('admin.article_management.articles.index');
    }

    public function create()
    {
        $langs = Language::get();
        return view('admin.article_management.articles.create', compact('langs'));
    }
    ...
    public function edit($id)
    {
        ...
        $categories = ArticleCategory::leftJoin('article_category_data' ,'article_category_data.category_id','article_category.id')
            ...
            ->get();
        return view('admin.article_management.articles.edit', compact('langs','article','article_data','categories'));
    }
