...
$destinationPath = $_SERVER['DOCUMENT_ROOT'] . "/public/uploads/content/".$_SESSION['store_id'] ;
...
$upload_dir = array(
    'img' => $_SERVER['DOCUMENT_ROOT'] . "/public/uploads/content/".$_SESSION['store_id']."/"  //"http://worldclass-tt.com/public/upload/content/",
...
// Append the requested resource location to the URL 
         //  $link .= $_SERVER['REQUEST_URI'];
            ...
            $url = $link . '/public/uploads/content/'.$_SESSION['store_id'] ."/". $f_name;
