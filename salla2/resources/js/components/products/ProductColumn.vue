<template>
    ...
    <div id="allProducts_div" class="row">
        <div class="col-md-4 col-sm-3" v-if="index < allProducts.length" v-for="productIndex, index in productToShow">
...
<!--                    <button type="button" class="bt btn-tiffany add-img" @click="getProdImgid(index)">اضف صوره</button>-->
>>>>>>> ce3952e51b39feb5de53e2825c14d35b5a64ad48
                </div>
                <div class="inputs-product-body">
                    <form>
                        ...
                        <span v-if="allProducts[index].id != null" style="float:left;margin-top: 9px" class="dropdown"><a data-toggle="dropdown" href="#">المزيد <i class="fa fa-angle-down"></i></a>
                        <ul class="dropdown-menu active">
                            <li><a href="javascript:void(0)">hide</a></li>
                            <li><a href="javascript:void(0)" @click="productdel(index)">delete</a></li>
                        </ul>
                        </span>
                        <div class="clearfix"></div>
                    </form>
...
<script>
    export default {
        props:['categories','product_type','allProducts','store'],
        data(){
            return {
                selected: '',
                productToShow: 6,
