    ...
    <div>
        <div class="card user">
            ...
            <div class="card-body position-relative">
                ...
                <span class="userIcon" :class="{hidden: uservisible}">
                    <div>{{username}}</div>
                    <div v-if="phonenumber != null"><i class="fa fa-phone" style="color:#5dd5c4"></i> {{phonenumber}}</div>
                </span>
            </div>
        </div>
    </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <a href="javascript:void(0)" @click="addUser()"><i class="fa fa-plus"></i> إضافة عميل جديد</a>
                        </div>
                    </div>
                    <br>
                    <br>
