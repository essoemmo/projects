            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="shipping_details" :class="{hidden: shippingaccept == 0}">
                        ...
                        <div class="form-group">
                            <select name="countries" class="form-control" v-model="address.countries" @change="getcities(address.countries)">
                                <option value="">اختر الدوله</option>
                                <option v-for="country in allcountry" :key="country.id" :value="country">{{country.title}}</option>
                            </select>
                        </div>
                        <div class="form-group">
                            <select name="cities" class="form-control" v-model="address.cities" @change="CheckHasShip(address.countries,address.cities)">
                    ...
                    <div class="shipping_options" :class="{hidden: shippingaccept == 0}">
                        ...
                        <div class="options" :class="{hidden : !optionvisible}">
                            <div class="option-column row" v-for="option in options">
                                <div class="col-sm-8">
                                    <label :for="option.id">
