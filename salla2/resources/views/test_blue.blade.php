...
<head>
    ...
    <title>Salla shop</title>
    <!--    <link href="css/bootstrap.min.css" rel="stylesheet">-->
    <link href="https://fonts.googleapis.com/css?family=Tajawal&display=swap" rel="stylesheet">
    <link href="{{asset('blue/css/bootstrap-rtl.css')}}" rel="stylesheet">
    <link href="{{asset('blue/css/font-awesome.min.css')}}" rel="stylesheet">
    <link href="{{asset('blue/css/animate.css')}}" rel="stylesheet">
    <link href="{{asset('blue/css/droopmenu-rtl.css')}}" rel="stylesheet">
    <link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/simplebar@latest/dist/simplebar.css">
    <link href="{{asset('blue/css/owl.carousel.min.css')}}" rel="stylesheet">
    <link href="{{asset('blue/css/nice-select.css')}}" rel="stylesheet">
    <link href="{{asset('blue/css/style.css')}}" rel="stylesheet" id="cpswitch">
            ...
            <div class="container">
                <div class="justify-content-between align-items-center d-flex">
                    ...
                    <ul class="user-helper  nav ">
                        ...
                        <li class="nav-item"><a href="" class="nav-link"><i class="fa fa-user-plus"></i>تسجيل عضوية</a>
                        </li>
                        <li class="nav-item"><a href="" class="nav-link"><i class="fa fa-lock"></i>تسجيل الدخول</a></li>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-2 align-self-center">
                        <div class="logo">
                            <a href=""><img data-src="images/logo.png" alt="" class="img-fluid lazy"></a>
                        </div>
                    </div>
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <select class="nice-select">
                                                <option selected>كل الفئات</option>
                                ...
                                <div class="dropdown-cart-wrapper">
                                    ...
                                    <div class="shopping-cart ">
                                        ...
                                        <ul class="shopping-cart-items list-unstyled" id="scrl">
                                            <li class="clearfix">
                                                <img src="images/demo.jpg" alt="item1"/>
...
<div class="carousel-section   ">
    <div class="container">
        <div class="section-title">افضل شركات التوصيل</div>
        <div class="fastest-delivery owl-carousel owl-theme">
            <div class="single-brand  text-center d-flex flex-column">

                <div class="thumbnail">
                    <a href=""><img data-src="images/demo-logo.png" alt="" class="img-fluid lazy"></a>
                </div>
                <h4>شركة ارامكس</h4>
        ...
        <div class="row">
            <div class="col-lg-3 col-md-6 d-flex ">
                <div class="single-full-product text-center d-flex flex-column">
                    ...
                    <h3 class="title"><a href="">اسم المنتج</a></h3>
                    ...
                    <div class="shop-owner">صاحب المتجر </div>
                </div>
            </div>
            <div class="col-lg-3 col-md-6 d-flex ">
                <div class="single-full-product text-center d-flex flex-column">
...
<div class="shop-features common-wrapper">
    <div class="container">
        <div class="section-title">
            مميزات متجرنا
        </div>
        <div class="row">
            <div class="col-lg-3 col-md-6">
                <div class="single-feature">
                    ...
                    <p class="description">كان لوريم إيبسوم ولايزال المعيار للنص الشكلي منذ القرن الخامس عشر عندما قامت
            ...
            <div class="col-lg-3 col-md-6">
                <div class="single-testimonial">
                    <div class="grad-border">
                        <div class="title">مصداقية وامانة</div>
                        <p class="description">كان لوريم إيبسوم ولايزال المعيار للنص الشكلي منذ القرن الخامس عشر عندما قامت
                            مطبعة مجهولة برص مجموعة من الأحرف</p>
                        <div class="rate">
                            <div class="star-ratings-sprite"><span style="width:88%"
        ...
        <div class="row">
            <div class="col-md-4 align-self-center">
                <div class="subscribe-headers">
                    ...
                    <p>اشترك في القائمة البريدية ليصلك كل ماهو جديد </p>
                </div>
            </div>
            <div class="col-md-8 align-self-center">
                <div class="subscribe-form">
                    <form action="">
                        ...
                        <input type="submit" class="subscribe-btn" value="اشترك الآن">
                    </form>
                </div>
            </div>
        </div>
...
<footer class="text-center">
    ...
    <div class="container">
        ...
        <div class="footer-about-shop">
            ...
            <p> هي الشكل وليس المحتوى) ويُستخدم في صناعات المطابع ودور النشر. كان لوريم إيبسوم ولايزال المعيار
                للنص الشكلي منذ القرن الخامس عشر عندما قامت مطبعة مجهولة برص مجموعة هي الشكل وليس المحتوى) ويُستخدم في
                صناعات المطابع ودور النشر. كان لوريم إيبسوم ولايزال المعيار
                للنص الشكلي منذ القرن الخامس عشر عندما قامت مطبعة مجهولة برص مجموعة</p>
        </div>
    ...
    <div class="copyrights ">
        <div class="container">
            <div class="text-center">
                <div>Copyright © 2018 .com™. <a href="serv5.com" class="light-blue">By serv5.com</a></div>
