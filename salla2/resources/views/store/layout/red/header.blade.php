...
<!--    <link href="css/bootstrap.min.css" rel="stylesheet">-->
    ...
    <link href="{{asset('red/css/flexslider-rtl-min.css')}}" rel="stylesheet">
    <link href="{{asset('red/css/flexslider.css')}}" rel="stylesheet">
                            ...
                            <div class="dropdown-cart-wrapper">
                                ...
                                <div class="shopping-cart ">
                                    ...
                                    @else
                                        ...
                                        <a style="display: none" href="{{route('store.checkout' , app()->getLocale())}}"
                                           class="button">{{_i('Pay')}}</a>
