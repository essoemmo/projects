...
<!--    <link href="css/bootstrap.min.css" rel="stylesheet">-->
    ...
    <link href="{{asset('blue/css/flexslider.css')}}" rel="stylesheet">
    <link href="{{asset('blue/css/flexslider-rtl-min.css')}}" rel="stylesheet">
                                ...
                                <div class="dropdown-cart-wrapper">
                                    <div class="text-center">
                                        ...
                                        <a href="#" id="cart">
                                            ...
                                            @endif
                                            <strong class="cart-text">{{_i('Shopping cart')}} </strong>
                                        </a>
                                    </div>
                                            ...
                                            @if(!empty(count(\Gloudemans\Shoppingcart\Facades\Cart::content())))
                                                @foreach(\Gloudemans\Shoppingcart\Facades\Cart::content() as $item)
                                                    ...
                                                    <li class="clearfix">
                                                        ...
                                                        <span class="item-name" style=" background: ;display: inline-block;
                                                        width: 20px;
                                                        height: 20px;
                                                        border-radius: 50%;
            ...
            <div class="droopmenu-nav">
                <ul class="droopmenu">
                    ...
                    @if(count($list = \App\Bll\Utility::getCustomDesign()) > 0)
                        ...
                        @endforeach
                    @else
                        <li><a class="active" href="{{ route('store.home',app()->getLocale()) }}">{{_i('Home')}}</a>
                        </li>
