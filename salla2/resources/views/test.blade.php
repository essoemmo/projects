...
<head>
    ...
    <link href="{{asset('perpal/css/bootstrap.min.css')}}" rel="stylesheet">
...
<header>
    <div class="top-header">
        <div class="top-bar ">
            <div class="container">
                <div class="justify-content-end align-items-center d-md-flex">
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-md-2 align-self-center">
                        <div class="logo">
                            <a href=""><img data-src="perpal/images/logo.png" alt="" class="img-fluid lazy"></a>
                        </div>
                    </div>
                    <div class="col-md-10 align-self-center">
                        <div class="row">
                            ...
                            <div class="col-lg-4 col-md-4 d-md-flex align-items-center justify-content-between header-left-links">


                                <div class="dropdown d-inline-block">
                                    <a class="signin-btn dropdown-toggle" href="#" role="button" id="dropdownMenuLink"
                                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        تسجيل الدخول
                                    </a>
                                ...
                                <div class="dropdown-cart-wrapper d-inline-block">
                                    <div class="text-center">
                                        <a href="#" id="cart">
                                            <div class="cart-text"> عربة التسوق <i class="fa fa-shopping-basket"></i>
...
<nav aria-label="breadcrumb" class="breadcrumb-wrapper">
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">منتج</li>
        </ol>
    </div>
</nav>
        ...
        <div class="row">
            <div class="col-lg-6">
                <ul id="vertical" class="single-product-carousel">
                    <li data-thumb="images/apparel-assortment-boutique-1336873.png">
                        <img src="{{asset('perpal/images/apparel-assortment-boutique-1336873.png')}}"/>
                    </li>
                    <li data-thumb="images/advertisement-advertising-bargain-2529787.png">
                        <img src="{{asset('perpal/images/advertisement-advertising-bargain-2529787.png')}}"/>
                    </li>
                    <li data-thumb="images/apparel-assortment-boutique-1336873.png">
                        <img src="{{asset('perpal/images/apparel-assortment-boutique-1336873.png')}}"/>
                    </li>
                ...
                <div class="single-full-product   p-3">
                    ...
                    <div class="media">
                        ...
                        <div class="media-body">
                            <h2 class="title"><a href="">جاكيت كلاسيك رجالى</a></h2>
                            <p>
                                دريس طويل ماكسي ب أكمام طويله .. مقاسات ميديم و لارج و اكس لارج
                                كم 40 سنتي .. طول 120 سنتي .. عرض الكتف 45 سنتي
                            </p>
                            <p>
                                أطلب خلال 9 ساعة 48 دقيقة
                                عشان توصلك في الثَلاثاء, أكتوبر 1
                            </p>
                            <div class="price">السعر : 1500 جنيهاً <span class="color-purple"> بدلا من 2000 جنيه</span></div>

                            <div class="d-md-flex justify-content-between align-items-center my-4">
                                <div class="quantity">
                                    <label>الكمية</label>
                                    <input type="number" class="form-control  d-inline-block w-auto" min="1" value="1">
                                </div>
                            ...
                            <div class="cart-product-options ">
                                <ul class="list-inline d-md-flex justify-content-center align-items-center my-4">
                                    <li class="list-inline-item"><a href="" class="btn btn-mainColor"><i class="fa fa-heart-o"></i> اضف الى
                                            المفضلة</a></li>
                                    <li class="list-inline-item"><a href="" class="btn btn-mainColor"><i class="fa fa-shopping-basket"></i> أضف إلى عربة التسوق</a></li>
                                </ul>
                            </div>
                        </div>
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <ul class="list-inline">
                    <li class="list-inline-item"><a href="">تسجيل الدخول</a></li>
                    <li class="list-inline-item"><a href="">انضم الينا</a></li>
                </ul>
                <form action="">
                ...
                <div class="copyrights">تصميم وتطوير <a href="http://serv5.com">سيرف فايف </a></div>
