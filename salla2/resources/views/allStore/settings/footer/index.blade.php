    ...
    <form  class="form-horizontal" action="{{url('/adminpanel/settings/footer/update')}}"  method="POST" class="form-horizontal"  id="form_2" data-parsley-validate="">
        ...
        <div class="box-body">
            ...
            <div class="form-group row">
                ...
                <label for="title_1" class="col-xs-2 control-label" > {{_i('Title')}} <span style="color: #db1b4c"> * </span></label>
            ...
            <div class="form-group row">
                ...
                <label for="country_id" class="col-xs-2 control-label">{{_i('Category')}} <span style="color: #db1b4c"> * </span></label>
            ...
            <div class="form-group row">
                ...
                <label for="link_1" class="col-xs-2 control-label" >{{_i('Link')}} <span style="color: #db1b4c"> * </span></label>

                <div class="col-xs-10">
                     <textarea  class="form-control" id="link_1" name="link" maxlength="191"	data-parsley-maxlength="191"
                                type="url" data-parsley-type="url" required=""></textarea>
    ...
    <form class="form-horizontal"  id="form_1" method="post" action="{{route('footer.store')}}"  data-parsley-validate="">
        ...
        <div class="box-body">
            ...
            <div class="form-group row">
                ...
                <label for="title" class="col-xs-2 control-label" >{{_i('Title')}} <span style="color: #db1b4c"> * </span></label>
            ...
            <div class="form-group row">
                ...
                <label for="category_id" class="col-xs-2 control-label">{{_i('Category')}} <span style="color: #db1b4c"> * </span> </label>
            ...
            <div class="form-group row">
                ...
                <label for="link" class="col-xs-2 control-label" >{{_i('Link')}} <span style="color: #db1b4c"> * </span></label>

                <div class="col-xs-10">
                                <textarea  class="form-control" id="link" name="link" maxlength="191"	data-parsley-maxlength="191"
                                          type="url" data-parsley-type="url" required="">{{old('link')}}</textarea>
            ...
            <div  id="dataTableBuilder_wrapper" class="dataTables_wrapper form-inline dt-bootstrap">
                ...
                <div class="dt-buttons" style="padding-right: 330px;">
                    <button class="dt-button btn btn-default"  type="button"  data-toggle="modal" data-target="#modal-default">
                        <span><i class="fa fa-plus"></i> {{_i('create new footer ')}} </span>
                    </button>
