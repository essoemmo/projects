...
@section('page_url')
    ...
    <li class="active"><a href="{{url('/adminpanel/user/profile/'.$user->id.'/edit')}}">{{_i('Edit')}} </a></li>
@endsection
...
@section('content')
    ...
    <div class="box box-info">
        ...
        <div class="box-body">
            ...
            <form method="post" action="{{url('/adminpanel/user/'.$user->id.'/edit')}}" class="form-horizontal"  id="demo-form" data-parsley-validate="">
                @csrf
