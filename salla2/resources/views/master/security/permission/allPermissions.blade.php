    ...
    <div class="row">
        ...
        <div class="col-sm-12 mbl">
            <span class="pull-left">
                  <a href="{{url('master/permission/add')}}" data-toggle="modal" data-target="#create" class="btn btn-primary create add-permission">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  action="{{url('/master/permission/add')}}" method="post" class="form-horizontal"  id="demo-form" data-parsley-validate="">
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            ...
            $('#permission_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{url('master/permission/get_datatable')}}',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
        ...
        $(document).ready(function () {
            ...
            $('body').on('click','.edit',function (e) {
                ...
                var html = `<form  action="{{url('master/permission/update')}}" method="post" class="form-horizontal"  id="formedit" data-parsley-validate="">
