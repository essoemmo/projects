...
<a class="btn btn-danger waves-effect waves-light remove-record"  data-url="{{ \Illuminate\Support\Facades\URL::route('admin_master.destroy', $id) }}" data-id="{{$id}}" style="color: white;"><i class="ti-trash"></i> {{_i('Delete')}}</a>
