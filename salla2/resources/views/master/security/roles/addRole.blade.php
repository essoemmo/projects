...
'additionalPageUrl' => url('/master/role/all') ,
...
@section('content')
    ...
    <div class="page-body">
        ...
        <div class="card blog-page" id="blog">
            ...
            <form  action="{{url('/master/role/add')}}" method="post" class="form-horizontal"  id="demo-form" data-parsley-validate="">
    ...
    <script  type="text/javascript">
        ...
        $('#selected_lang').on('change', function(){
            ...
            $.ajax({
                ...
                url: "{{url('/master/permission/')}}/"+langId+"",
                type: "get",
