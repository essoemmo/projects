...
'additionalPageUrl' => url('/master/content_management/create') ,
...
<div class="row">
    ...
    <div class="col-sm-12 mbl">
         <span class="pull-left">
             <a href="{{url('master/content_management/create')}}" target="_blank" class="btn btn-primary create ">
    ...
    <script type="text/javascript">
        ...
        $(function(){
            table = $('#content_data').DataTable({
                ...
                "serverSide": true,
                ajax: {
                    url: "{{url('master/content_management')}}",
                    //data: { "resource": "content_management" }
                },
                columns: [
                    {data: 'id'},
                    {data: 'title'},
        ...
        function type(){
            ...
            table = $('#content_data').DataTable({
                processing: true,
                serverSide: true,
                ajax: "{{url('master/content_management')}}?type="+type,
                columns: [
                    {data: 'id'},
                    {data: 'title'},
                    {data: 'columns'},
