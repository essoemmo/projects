...
@section('content')
    ...
    <!-- =====Filter Section===== -->
    <div class="box-body" >
        <form action="{{url('master/content_management/'.$content_section->id)}}" method="POST" enctype="multipart/form-data" data-parsley-validate="" >
            @method('PUT')
            <?= csrf_field() ?>
                    ...
                    <div class="row mb-2">
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="{{url('/master/content_management')}}" class="btn btn-default"><i class="ti-list"></i> {{ _i('All Contents') }}</a></li>
                                <li class="breadcrumb-item active">
                                    <a href="{{url('master/content_management/'.$content_section->id)}}" >
