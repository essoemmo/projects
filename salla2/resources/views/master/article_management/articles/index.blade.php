...
'title' => _i('Articles'),
'subtitle' => _i('Articles'),
'activePageName' => _i('Articles'),
'additionalPageUrl' => url('/master/articles/create') ,
    ...
    <div class="row">
        ...
        <div class="col-sm-12 mbl">
         <span class="pull-left">
             <a href="{{url('master/articles/create')}}" target="_blank" class="btn btn-primary create ">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form  action="{{url('/master/articles/lang/store')}}" method="post" class="form-horizontal"  id="lang_submit" data-parsley-validate="">
...
@push('js')
    ...
    <script  type="text/javascript">
        ...
        $('body').on('click','.lang_ex',function (e) {
            ...
            $.ajax({
                url: '{{ url('master/articles/get/lang/value') }}',
                method: "get",
                data: {
                    lang_id: lang_id,
