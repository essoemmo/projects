...
'title' => _i('Add Chat'),
'subtitle' => _i('Add Chat'),
'activePageName' => _i('Add Chat'),
'additionalPageUrl' => url('/master/chat') ,
'additionalPageName' => _i('Chat'),
] )
        ...
        <div class="col-sm-12">
            <div class="card">
                <div class="card-header">
                    <h5> {{ _i('Add Chat') }} </h5>
                    <p class="text-danger" style="text-align: center;font-weight: bold;"> {{ _i('PLEASE REPLACE THE APP ID BY APP-ID') }} </p>
                ...
                <div class="card-block">
                    <form method="POST" action="{{ route('chat.store') }}" class="form-horizontal"  id="demo-form" data-parsley-validate="" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="card-body card-block">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <textarea required="" class="form-control " name="script"   style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" placeholder="Place write script here...">{{old('script')}}</textarea>
