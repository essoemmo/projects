...
<head>
    ...
    @else
        <title> {{ _i('Salla') }} | {{ !empty($title)? $title: _i('admin login') }}</title>
    @endif
    ...
    <link rel="icon" href="{{asset('master/assets/images/favicon.ico')}}" type="image/x-icon">
    <!-- Google font-->
    <link href="https://fonts.googleapis.com/css?family=Open+Sans:300,400,600,700,800" rel="stylesheet">
    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="{{asset('masterAdmin/bower_components/bootstrap/css/bootstrap.min.css')}}">
                ...
                <div class="login-card card-block auth-body">
                    ...
                    <form class="md-float-material" method="post" action="{{route('PostLogin')}}">
                        ...
                        <div class="text-center">
                          ...
                          <img src="{{ asset($setting->logo) }}" alt="logo.png" style="margin-top:40px; height: 100px;width: 250px;background: white;">
                        </div>
                        <div class="auth-box">
                            ...
                            <div class="row m-t-25 text-left">
                                ...
                                <div class="col-sm-5 col-xs-12 forgot-phone text-right">
                                    <a href="{{ url('forgetPassword') }}" class="text-right f-w-600 text-inverse"> {{ _i('forget password') }} ?</a>
                                </div>
                            </div>
...
<script type="text/javascript" src="{{asset('masterAdmin/bower_components/jquery-slimscroll/js/jquery.slimscroll.js')}}"></script>
<!-- modernizr js -->
...
<script type="text/javascript" src="{{asset('masterAdmin/bower_components/i18next-xhr-backend/js/i18nextXHRBackend.min.js')}}"></script>
<script type="text/javascript" src="{{asset('masterAdmin/bower_components/i18next-browser-languagedetector/js/i18nextBrowserLanguageDetector.min.js')}}"></script>
<script type="text/javascript" src="{{asset('masterAdmin/bower_components/jquery-i18next/js/jquery-i18next.min.js')}}"></script>
<!-- Custom js -->
<!--<script type="text/javascript" src="assets/js/script.js"></script>-->
<!---- color js --->
<script type="text/javascript" src="{{asset('masterAdmin/assets/js/common-pages.js')}}"></script>
