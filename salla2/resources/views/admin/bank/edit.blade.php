...
@section('page_url')
    ...
    <li class="active"><a href="{{url('/adminpanel/transferBank/edit')}}">{{_i('edit')}}</a></li>
@endsection
    ...
    <div class="page-header">
        ...
        <div class="page-header-breadcrumb">
            <ul class="breadcrumb-title">
                ...
                <li class="breadcrumb-item"><a href="#!">{{_i('edit bank')}}</a>
                </li>
            </ul>
        </div>
    </div>
            ...
            {!! Form::model($bank,['route'=>['transferBank.update',$bank->id],'method'=>'PUT','class'=>'form-horizontal','files'=>true,'data-parsley-validate'=>'']) !!}
                <div class="box-body">
                    ...
                    <div class="form-group">
                        ...
                        <!-- Photo -->
                        <div class="col-sm-6">
                            <img class="img-responsive pad" id="article_img" style="margin: 0 auto; width: 270px; height: 270px;display: block;" src="{{$bank->logo}}">
                        </div>
                    </div>
