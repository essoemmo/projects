...
<a href="{{url('adminpanel/settings/offer/'.$id.'/edit')}}" class="edit btn btn-primary">
    <i class="ti-pencil-alt"></i>
</a>
<a class="btn btn-danger btn-circle waves-effect waves-light remove-record" data-toggle="modal" data-url="{{ url('adminpanel/settings/offer/'.$id) }}" data-id="{{$id}}" data-target="#custom-width-modal" style="color: white;"><i class="ti-trash"></i></a>
