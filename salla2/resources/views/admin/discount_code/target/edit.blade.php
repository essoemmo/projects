...
@section('content')
    ...
    <div class="page-body">
        <!-- Blog-card start -->
        <form  action="{{ url('adminpanel/settings/offer/'.$discount->id.'/update')}}" method="post" class="form-horizontal" data-parsley-validate="" >
            @csrf
