...
<nav class="pcoded-navbar" pcoded-header-position="relative">
    ...
    <div class="pcoded-inner-navbar main-menu">
        <div class="">
            <div class="main-menu-header">
                ...
                <a href="{{request()->getScheme()}}://{{\App\Bll\Utility::getStoreDomain()}}.{{ $domain }}">
                    <img class="img-fluid img-circle" style="width: 50px" class="" src="<?= \App\Bll\Utility::getSetting()->logo ?>" alt="Store logo">
                </a>
        ...
        <ul class="pcoded-item pcoded-left-item">
            ...
            @if ($orders_menu == 1)
                <li class=" {{request()->is('adminpanel/orders/all') ? 'active' :''}}">
                    <a href="{{url('/adminpanel/orders/all')}}"><i class="fa fa-address-book"></i>
            ...
            @can(['Transactions-Show'])
                <li class="pcoded-hasmenu {{(request()->is('adminpanel/orders/offline/*') || request()->is('adminpanel/orders/online/*')) ? 'pcoded-trigger':''}}">
                    <a href="javascript:void(0)">
                        <span class="pcoded-micon"><i class="ti ti-money"></i></span>
                        <span class="pcoded-mtext" data-i18n="nav.dash.analytics">{{_i('Transactions')}}</span>
                        <span class="pcoded-mcaret"></span>
                    </a>
                    <ul class="pcoded-submenu">
                        <li class="{{(request()->is('adminpanel/orders/offline/all')) ? 'active' : '' }}">
                            <a href="{{url('/adminpanel/orders/offline/all')}}">
                                <span class="pcoded-micon"><i class="ti-plus"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('Offline')}}</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="{{(request()->is('adminpanel/orders/online/all')) ? 'active' : '' }}">
                            <a href="{{url('/adminpanel/orders/online/all')}}">
                                <span class="pcoded-micon"><i class="ti-plus"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('Online')}}</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                    </ul>
            ...
            {{--            customers              --}}
            @can(['AdminUser-Add','AdminUser-Edit','AdminUser-Delete'])
            ...
            <li class="{{(request()->is('adminpanel/reports')) ? 'active' : '' }}">
                <a href="{{ url('/adminpanel/reports') }}"><i class="fa fa-circle-o"></i>
            ...
            <!--------------------------------------- setting start -------------------------------------------------------------------------->
            @if ($languages_menu == 1)
                <li class=" {{request()->is('adminpanel/languages')||request()->is('adminpanel/languages/create')||request()->is('adminpanel/country/*')
             || request()->is('adminpanel/city/*')  ? 'pcoded-trigger' : '' }}">
            ...
            {{-------------  comments -----------------}}
            @if ($comments_menu == 1)
                <li class="pcoded-hasmenu {{(request()->is('adminpanel/comments/*')) ? 'pcoded-trigger':''}}">
                    <a href="javascript:void(0)">
        ...
        <!---------------------------------- setting end ---------------------------------->
                ...
                <li class="pcoded-hasmenu {{request()->is('adminpanel/article/*')||request()->is('adminpanel/artcle_category/*')  ? 'pcoded-trigger' : '' }}">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="{{(request()->is('adminpanel/article/all')) ? 'active' : '' }} ">
                            <a href="{{url('/adminpanel/article/all')}}"><i class="fa fa-circle-o"></i>
                                <span class="pcoded-micon"><i class="ti-view-list"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('All')}}</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        ...
                        <li class="{{(request()->is('adminpanel/artcle_category/all')) ? 'active' : '' }} ">
                            <a href="{{url('/adminpanel/artcle_category/all')}}"><i class="fa fa-circle-o"></i>
                                <span class="pcoded-micon"><i class="ti-view-list"></i></span>
            ...
            {{-- @if ($pages_menu == 1) --}}
            <li class="{{request()->is('/adminpanel/pages') ? 'active' :''}}">
            ...
            {{--            security              --}}
            @can('Permission-Add')
                <li class="pcoded-hasmenu  {{request()->is('adminpanel/permission/*')||request()->is('adminpanel/role/*')||request()->is('adminpanel/membership/*')  ? 'pcoded-trigger' : '' }}">
                    <a href="javascript:void(0)">
                    ...
                    <ul class="pcoded-submenu">
                        ...
                        <li class="{{(request()->is('adminpanel/permission/*')) ? 'active' : '' }}">
                            <a href="{{url('/adminpanel/permission/all')}}"><i class="fa fa-circle-o"></i>
                                <span class="pcoded-micon"><i class="ti-view-list"></i></span>
                        ...
                        <li class="pcoded-hasmenu {{(request()->is('adminpanel/role/*')) ? 'pcoded-trigger':''}}">
                            ...
                            <ul class="pcoded-submenu">
                                <li class="{{(request()->is('adminpanel/role/add')) ? 'active' : '' }}">
                                    <a href="{{url('/adminpanel/role/add')}}"><i class="fa fa-circle-o"></i>
                                        <span class="pcoded-micon"><i class="ti-plus"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('Add')}}</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="{{(request()->is('adminpanel/role/all')) ? 'active' : '' }}">
                                    <a href="{{url('/adminpanel/role/all')}}"><i class="fa fa-circle-o"></i>
                                        <span class="pcoded-micon"><i class="ti-view-list"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('All')}}</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                        ...
                        <li class="pcoded-hasmenu {{(request()->is('adminpanel/user/*')) ? 'pcoded-trigger':''}}">
                            <a href="javascript:void(0)"><i class="fa fa-circle-o"></i>
                                <span class="pcoded-micon"><i class="ti-user"></i></span>
                            ...
                            <ul class="pcoded-submenu">
                                <li class="{{(request()->is('adminpanel/user/add')) ? 'active' : '' }}">
                                    <a href="{{url('/adminpanel/user/add')}}"><i class="fa fa-circle-o"></i>
                                        <span class="pcoded-micon"><i class="ti-plus"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('Add')}}</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                                </li>
                                <li class="{{(request()->is('adminpanel/user/all')) ? 'active' : '' }}">
                                    <a href="{{url('/adminpanel/user/all')}}"><i class="fa fa-circle-o"></i>
                                        <span class="pcoded-micon"><i class="ti-view-list"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('All')}}</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                ...
                <li class="pcoded-hasmenu {{(request()->is('adminpanel/ticket/*')) ? 'pcoded-trigger':''}}">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="{{(request()->is('adminpanel/ticket')) ? 'active' : '' }}">
                            <a href="{{url('/adminpanel/ticket')}}"><i class="fa fa-circle-o"></i>
                                <span class="pcoded-micon"><i class="ti-ticket"></i></span>
                        ...
                        <li class="{{(request()->is('adminpanel/ticket/completed/index')) ? 'active' : '' }}">
                            <a href="{{url('/adminpanel/ticket/completed/index')}}"><i class="fa fa-circle-o"></i>
                        ...
                        <li class="pcoded-hasmenu {{request()->is('adminpanel/ticketSetting/*') ? 'pcoded-trigger' :''}}">
                            ...
                            <ul class="pcoded-submenu">
                                <li class="{{(request()->is('adminpanel/ticketSetting/category')) ? 'active' : '' }}">
                                    <a href="{{url('/adminpanel/ticketSetting/category')}}"><i
                                ...
                                <li class="{{(request()->is('adminpanel/ticketSetting/priority')) ? 'active' : '' }}">
                                    <a href="{{url('/adminpanel/ticketSetting/priority')}}"><i
                                            class="fa fa-circle-o"></i>
                                ...
                                <li class="{{(request()->is('adminpanel/ticketSetting/agent')) ? 'active' : '' }}">
                                    <a href="{{url('/adminpanel/ticketSetting/agent')}}"><i class="fa fa-circle-o"></i>
                                        <span class="pcoded-micon"><i class="ti-user"></i></span>
                ...
                <li class="pcoded-hasmenu {{(request()->is('adminpanel/chat')||request()->is('adminpanel/chat')) ? 'pcoded-trigger':''}}">
                    ...
                    <ul class="pcoded-submenu">
                        <li class="{{(request()->is('adminpanel/chat')) ? 'active' : '' }}">
                            <a href="{{url('/adminpanel/chat')}}"><i class="fa fa-circle-o"></i>
                                <span class="pcoded-micon"><i class="ti-comments"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('chat room')}}</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
            ...
            @if ($ShippingOption_menu == 1)
                <li class="pcoded-hasmenu {{(request()->is('adminpanel/shipping_option/*')) ? 'pcoded-trigger':''}}">
                    <a href="javascript:void(0)"><i class="fa fa-circle-o"></i>
                    ...
                    <ul class="pcoded-submenu">
                        <li class="pcoded-hasmenu {{request()->is('adminpanel/companies/*') ? 'pcoded-trigger' :''}}">
                            <a href="javascript:void(0)"><i class="fa fa-circle-o"></i>
                            ...
                            <ul class="pcoded-submenu">
                                <li class="{{(request()->is('adminpanel/companies')) ? 'active' : '' }}">
                                    <a href="{{url('/adminpanel/companies')}}"><i class="fa fa-circle-o"></i>
                                        <span class="pcoded-micon"><i class="ti-bookmark"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('All')}}</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
                        ...
                        <li class="pcoded-hasmenu {{request()->is('adminpanel/shipping_option/*') ? 'pcoded-trigger' :''}}">
                            ...
                            <ul class="pcoded-submenu">
                                <li class="{{(request()->is('adminpanel/shipping_option/all')) ? 'active' : '' }}">
                                    <a href="{{url('/adminpanel/shipping_option/all')}}"><i class="fa fa-circle-o"></i>
                                        <span class="pcoded-micon"><i class="ti-view-list"></i></span>
                                        <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('All')}}</span>
                                        <span class="pcoded-mcaret"></span>
                                    </a>
            ...
            @if ($transactionType_menu == 1)
                <li class="pcoded-hasmenu {{request()->is('adminpanel/transactionType/*') ? 'pcoded-trigger' :''}}">
                    <a href="javascript:void(0)"><i class="fa fa-circle-o"></i>
                    ...
                    <ul class="pcoded-submenu">
                        <li class="{{(request()->is('adminpanel/transactionType/all')) ? 'active' : '' }}">
                            <a href="{{url('/adminpanel/transactionType/all')}}"><i class="fa fa-circle-o"></i>
                                <span class="pcoded-micon"><i class="ti-view-list"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('All')}}</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
            ...
            @can(['BankTransfer-Add','BankTransfer-Edit','BankTransfer-Delete'])
                <li class="pcoded-hasmenu {{request()->is('adminpanel/transferBank/*') ? 'pcoded-trigger' :''}}">
                    <a href="javascript:void(0)"><i class="fa fa-circle-o"></i>
                    ...
                    <ul class="pcoded-submenu">
                        <li class="{{(request()->is('adminpanel/transferBank')) ? 'active' : '' }}">
                            <a href="{{url('/adminpanel/transferBank')}}"><i class="fa fa-circle-o"></i>
                                <span class="pcoded-micon"><i class="ti-view-list"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('All')}}</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                        <li class="{{(request()->is('adminpanel/transferBank/create')) ? 'active' : '' }}">
                            <a href="{{url('/adminpanel/transferBank/create')}}"><i class="fa fa-circle-o"></i>
                                <span class="pcoded-micon"><i class="ti-plus"></i></span>
                                <span class="pcoded-mtext" data-i18n="nav.dash.default">{{_i('Add')}}</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
            ...
            @if ($contact_menu == 1)
                <li class="{{(request()->is('adminpanel/contact/*')) ? 'active' : '' }}">
                    <a href="{{url('/adminpanel/contact/all')}}"><i class="fa fa-circle-o"></i>
            ...
            @can(['Abandon-Cart'])
                ...
                <li class="pcoded-hasmenu {{(request()->is('adminpanel/abandoned_carts')) ? 'pcoded-trigger' : '' }}">
                    <a href="javascript:void(0)">
                        <span class="pcoded-micon"><i class="ti-flag-alt-2"></i></span>
                    ...
                    <ul class="pcoded-submenu">
                        <li class="{{(request()->is('adminpanel/abandoned_carts')) ? 'active' : '' }}">
                            <a href="{{ url('/adminpanel/abandoned_carts') }}">
                                <span class="pcoded-micon"><i class="ti-view-list"></i></span>
                                <span class="pcoded-cart" data-i18n="nav.dash.default">{{_i('All')}}</span>
                                <span class="pcoded-mcaret"></span>
                            </a>
                        </li>
                    </ul>
            ...
            @can(['Design'])
                <li class="{{(request()->is('adminpanel/design')) ? 'active' : '' }}">
                    <a href="{{url('/adminpanel/design')}}"><i class="fa fa-circle-o"></i>
