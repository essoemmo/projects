...
@section('content')
    ...
    <div class="page-body">
        <!-- Blog-card start -->
        <form  action="{{ url('adminpanel/campaign/store')}}" method="POST" class="form-horizontal" data-parsley-validate="" >
            @csrf
                            ...
                            <div class="card-body card-block text-center">
                                ...
                                <div class="form-group row " >
                                    ...
                                    <p id="message_preview" class="message to" >
                                        ...
                                        <br>
                                        <a href="https://salla.sa/fashion.house" target="_blank" >
