...
<a href="{{url('adminpanel/campaign/'.$id.'/edit')}}"  class="btn btn-primary" title="{{_i('Edit')}}"><i class="ti-pencil-alt"></i></a>
<a class="btn btn-danger remove-record" data-toggle="modal"  title="{{_i('Delete')}}"
   data-url="{{ \Illuminate\Support\Facades\URL::route('campaign.delete', $id) }}" data-id="{{$id}}" data-target="#custom-width-modal" style="color: white;">
