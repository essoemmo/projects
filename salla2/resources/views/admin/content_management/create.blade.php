...
<!-- =====Filter Section===== -->
<div class="box-body">
    <form action="{{url('adminpanel/content_management')}}" method="post" enctype="multipart/form-data"
                ...
                <div class="row mb-2">
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item"><a href="{{url('adminpanel/content_management')}}"
