...
@section('page_url')
    ...
    <li class="breadcrumb-item"><a href="{{url('adminpanel/artcle_category/all')}}">{{_i('Blog Categories')}}</a>
    </li>
@endsection
    ...
    <div class="page-body">
        ...
        <div class="card blog-page" id="blog">
            <div class="card-block">
                <form method="POST" action="{{ url('/adminpanel/article_cat/'.$article_cat->id.'/update') }}" class="form-horizontal"  id="demo-form" data-parsley-validate="" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="card-body card-block">
                            ...
                            <div class="col-sm-6">
                                <select class="form-control" name="lang_id" id="language_addform" required="">
                                    ...
                                    @foreach($langs as $lang)
                                        <option value="{{$lang->id}}" {{$article_cat_data['lang_id'] == $lang->id ? "selected":"" }}>{{_i($lang->title)}}</option>
                                    @endforeach
                                </select>
                            </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-6">
                                <input  type="text"  class="form-control{{ $errors->has('title') ? ' is-invalid' : '' }}" name="title" value="{{ $article_cat_data['title'] }}"  placeholder=" {{_i('Article Category Title')}}" required="">
                                @if ($errors->has('title'))
