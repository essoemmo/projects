                                    ...
                                    <div>
                                        <label>
                                            <input type="radio"
                                                   ...
                                                   @if($order->gettransactions->type == 'bank') checked @endif>
                                            {{ _i('Pay With Bank') }}
                                            <br/>
                                        </label>
                                    </div>
                                    <div>
                                        <label>
                                            <input type="radio"
                                                   ...
                                                   @if($order->gettransactions->type == 'delivery') checked @endif>
                                        ...
                                        <div>
                                            <label>
                                                <input type="radio"
                                                       ...
                                                       class="paymentMethod myfatoorah_show"
                                                       name="payment"
                                                       @if($order->gettransactions->type == 'online') checked @endif>
