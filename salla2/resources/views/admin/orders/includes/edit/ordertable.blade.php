                        ...
                        <tr>
                            ...
                            <td data-th="Quantity">
                                <input type="number" name="product[{{ $item->product_id }}][quantity]"
                                       data-price="{{ $item->price }}" value="{{ $item->count }}"
                                       min="1"
                                       class="quantity"/>
                            </td>
                            <td data-th="Subtotal" class="text-center Subtotal">{{ $item->price * $item->count }}</td>
    ...
    <script language="javascript">
        ...
        function getproduct(index) {
            ...
            if (productsfilters[index].product_photos.length == 0) {
                ...
                this.product.photo = 'http://localhost/salla2/images/placeholder.png'
            } else {
