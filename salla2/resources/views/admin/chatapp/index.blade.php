    ...
    <div class="page-body">
        ...
        <div class="row">
            ...
            <div class="col-md-2">
                <div class="chat-box-row">
                    <a data-id="{{ $chat->id }}"  class="show-data">
                     <img class="media-object" src="{{ asset('images/' . $chat->avatar) }}" alt="Generic placeholder image">
                    </a>

                    @if($script_id == $chat->id)

                    <h6 class="text-success"> <i class="icofont icofont-brand-nike" style="font-size: 35px;display: block;"></i>  {{ _i('Choosed')}} </h6>
        ...
        <div class="modal fade modal-flex" id="view-tabs" tabindex="-1" role="dialog">
            <div class="modal-dialog" role="document">
                ...
                <form method="POST" action="{{ url('adminpanel/chat/choose') }}">
                    @csrf
                ...
                <div class="modal-content">
                    <div class="modal-body">
                        ...
                        <div class="tab-content modal-body">
                            ...
                            <div class="tab-pane" id="tab-profile" role="tabpanel">
                                <h4 class="text-info"> {{ _i('App ID')}} </h4>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary mobtn" data-dismiss="modal">{{_i('close') }}</button>
                        <button type="submit" class="btn btn-primary mobtn"> {{_i('choose') }}</button>
                    </div>
