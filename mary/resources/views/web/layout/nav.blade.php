    ...
    <div class="droopmenu-inner">
        ...
        <div class="droopmenu-nav">
            <ul class="droopmenu">
                            ...
                            <div class="droopmenu-row dm-equalize">
                                ...
                                <div class="droopmenu-col droopmenu-col4">
                                    <div class="droopmenu-content dm-border-right">
                                        ...
                                        <h4>{{_i('Social Media')}}</h4>
                                        <div class="droopmenu-social-icons">
                                            <a href="{{settings()['facebook_url']}}" class="dms-icon dm-facebook"> <i
                                                    class="ion-social-facebook"></i> </a>
                                            <a href="{{settings()['twitter_url']}}" class="dms-icon dm-twitter"> <i
                                                    class="ion-social-twitter"></i> </a>
                                            <a href="{{settings()['instagram_url']}}" class="dms-icon dm-instagram"><i
                                ...
                                <div class="droopmenu-col droopmenu-col4">
                                    <div class="droopmenu-content">
                                        ...
                                        <ul class="droopmenu-icon-links">
                                            <li>
                                                <a href="{{settings()['facebook_url']}}">Security</a>
                                            ...
                                            <li>
                                                <a href="{{settings()['twitter_url']}}">Twitter</a>
                                                <div class="dm-details">
                                                    <span>Twitter </span>
                                                </div>
                                                <div class="dm-icon-holder">
                ...
                <li>
                    <a href="{{url('/contact')}}"> {{_i('Contact Us')}} </a>
                </li>
            </ul>
        </div><!-- droopmenu-nav -->
