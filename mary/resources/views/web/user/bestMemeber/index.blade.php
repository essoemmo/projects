    ...
    <nav aria-label="breadcrumb" class="breadcrumb-wrapper">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{_i('BestUser')}} </li>
            </ol>
        </div>
    </nav>
    ...
    <section class="latest-members  common-wrapper ">
        <div class="container">
            ...
            <div id="data">
                ...
                @include('web.user.bestMemeber.ajax')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('change', '#country', function (e) {
                ...
                var val = $(this).val();
                $.ajax({
                    url: '{{ route('get-bestUser-country') }}',
                    method: "get",
                    data: {val: val},
