    ...
    <nav aria-label="breadcrumb" class="breadcrumb-wrapper">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page">{{_i('last member')}}</li>
            </ol>
        </div>
    </nav>
    ...
    <section class="latest-members  common-wrapper ">
        <div class="container">
            ...
            <div id="data">
                ...
                @include('web.user.latestUser.ajax')
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('change','#country',function (e) {
                ...
                var val  = $(this).val();
                $.ajax({
                    url: '{{ route('get-latestUser-country') }}',
                    method: "get",
                    data: {val:val},
            ...
            $('body').on('click','#filter',function (e) {
                ...
                $.ajax({
                    url: '{{ route('get-latestUser-filter') }}',
                    method: "get",
                    data: {filter:filter},
                    success: function (response) {
                        $('#data').html(response)
