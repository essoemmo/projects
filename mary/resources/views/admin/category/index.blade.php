...
@section('content')
    ...
    <!-- /.box-header -->
        <div class="card-body table-responsive">
            ...
            <button class="btn btn-primary create" data-toggle="modal" data-target="#create"><i class="fa fa-plus"></i>{{_i('create new Category')}}</button>
            @endif
            {!! $dataTable->table([
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('click','.edit',function (e) {
                ...
                var html = `<form action="{{route('edit-category')}}"  method="post" id="formedit">
                    @csrf
                        {{method_field('put')}}
