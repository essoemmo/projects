...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 23, 2019 at 10:42 PM
...
(17, 'ar name', 1, 9, '2019-12-17 06:15:26', '2019-12-18 07:50:18'),
(18, 'en name', 2, 9, '2019-12-17 06:15:26', '2019-12-18 07:50:18'),
(19, 'fr name', 5, 9, '2019-12-17 06:15:26', '2019-12-18 07:50:18'),
(20, 'po name', 6, 9, '2019-12-17 06:15:26', '2019-12-18 07:50:19');
...
(32, 18, 'العضوية الذهبية', '<p>wewewee</p>', 1, NULL, '2019-12-18 02:49:28', '2019-12-23 02:53:37'),
(33, 18, 'golden member', '<p>ewccwec</p>', 2, NULL, '2019-12-18 02:49:28', '2019-12-23 02:53:37'),
(34, 18, 'golden member fr', '<p>233223</p>', 5, NULL, '2019-12-18 02:49:28', '2019-12-23 02:53:37'),
(35, 18, 'golden po', '<p>dsfdsafsdf</p>', 6, NULL, '2019-12-18 02:49:28', '2019-12-23 02:53:37'),
(36, 19, 'العضوية الفضية', '<p>الوصف بالعربي</p>', 1, NULL, '2019-12-18 04:20:44', '2019-12-18 04:38:04'),
(37, 19, 'member silver', '<p>ndescrption en</p>', 2, NULL, '2019-12-18 04:20:45', '2019-12-18 04:38:04'),
(38, 19, 'member fra', '<p>descrption fr</p>', 5, NULL, '2019-12-18 04:20:45', '2019-12-18 04:38:04'),
(39, 19, 'memebr po', '<p>descrption po</p>', 6, NULL, '2019-12-18 04:20:45', '2019-12-18 04:38:04'),
(40, 20, 'asasx', NULL, 1, NULL, '2019-12-18 07:46:57', '2019-12-18 07:46:57'),
(41, 20, 'asaas', NULL, 2, NULL, '2019-12-18 07:46:57', '2019-12-18 07:46:57'),
(42, 20, 'as', NULL, 5, NULL, '2019-12-18 07:46:57', '2019-12-18 07:46:57'),
(43, 20, 'asdasd', NULL, 6, NULL, '2019-12-18 07:46:57', '2019-12-18 07:46:57'),
(44, 21, 'xzc', NULL, 1, NULL, '2019-12-23 02:47:15', '2019-12-23 02:47:27'),
(45, 21, 'czxczxc', NULL, 2, NULL, '2019-12-23 02:47:16', '2019-12-23 02:47:27'),
(46, 21, 'zxczxc', NULL, 5, NULL, '2019-12-23 02:47:16', '2019-12-23 02:47:27'),
(47, 21, 'zxczxczxczxc', NULL, 6, NULL, '2019-12-23 02:47:16', '2019-12-23 02:47:27');
...
INSERT INTO `membership_options` (`id`, `created_at`, `updated_at`, `membership_type_id`) VALUES
(134, '2019-12-18 04:38:05', '2019-12-18 04:38:05', 19),
(135, '2019-12-18 04:38:05', '2019-12-18 04:38:05', 19),
(136, '2019-12-18 04:38:05', '2019-12-18 04:38:05', 19),
(137, '2019-12-18 04:38:05', '2019-12-18 04:38:05', 19),
(138, '2019-12-23 02:53:37', '2019-12-23 02:53:37', 18),
(139, '2019-12-23 02:53:37', '2019-12-23 02:53:37', 18),
(140, '2019-12-23 02:53:38', '2019-12-23 02:53:38', 18),
(141, '2019-12-23 02:53:38', '2019-12-23 02:53:38', 18),
(142, '2019-12-23 02:53:38', '2019-12-23 02:53:38', 18),
(143, '2019-12-23 02:53:38', '2019-12-23 02:53:38', 18),
(144, '2019-12-23 02:53:38', '2019-12-23 02:53:38', 18);

-- --------------------------------------------------------

--
-- Table structure for table `membership_option_data`
--

CREATE TABLE `membership_option_data` (
  `id` int(11) NOT NULL,
  `membership_option_id` int(10) UNSIGNED NOT NULL,
  `name` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `lang_id` bigint(20) UNSIGNED NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
...
--
-- Dumping data for table `membership_option_data`
--

INSERT INTO `membership_option_data` (`id`, `membership_option_id`, `name`, `lang_id`, `created_at`, `updated_at`) VALUES
(97, 134, 'سامر', 1, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(98, 135, 'samer', 2, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(99, 136, 'samer fr', 5, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(100, 137, 'sa po', 6, '2019-12-18 04:38:06', '2019-12-18 04:38:06'),
(101, 138, 'سامؤ', 1, '2019-12-23 02:53:37', '2019-12-23 02:53:37'),
(102, 139, 'سامر 1', 1, '2019-12-23 02:53:37', '2019-12-23 02:53:37'),
(103, 140, 'samer', 2, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(104, 141, 'Samer 1', 2, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(105, 142, 'samer fr', 5, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(106, 143, '1samer fr', 5, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(107, 144, 'samer po', 6, '2019-12-23 02:53:38', '2019-12-23 02:53:38');
...
CREATE TABLE `membership_types` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `type` enum('together','male','female') COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
(18, 'uIcRzNDqAUlO7Oyl2HiAjTUmAiGnmnXrNGiomtT9.png', '2019-12-18 02:49:28', '2019-12-23 02:53:37', NULL, 250, '2019-12-28'),
(19, 'NEdb1tHTxysFOUqUctldgTvb6KJu3LMpGw4hdHLj.png', '2019-12-18 04:20:44', '2019-12-18 04:22:01', 'male', 50, '2019-12-28'),
(20, NULL, '2019-12-18 07:46:56', '2019-12-18 07:46:56', NULL, NULL, NULL),
(21, NULL, '2019-12-23 02:47:15', '2019-12-23 02:47:15', NULL, NULL, NULL);
...
--
-- Table structure for table `message_attaches`
--
...
(61, '2019_12_17_170249_create_member_ship_option_data_table', 18),
(62, '2019_12_17_182919_create_permission_optionMemberships_table', 19),
(63, '2019_12_17_202958_create_partenerships_table', 20),
(65, '2019_12_17_214709_create_story_datas_table', 21),
(66, '2019_12_18_111020_create_user_logins_table', 22),
(67, '2019_12_19_163115_create_sms_table', 23),
(68, '2019_12_19_165759_create_sms_datas_table', 24),
(69, '2019_12_19_194159_create_user_settings_table', 25),
(71, '2019_12_19_213756_create_message_attaches_table', 26),
(72, '2019_12_19_213137_create_role_settings_table', 27),
(73, '2019_12_19_233922_create_transaction_types_table', 28),
(74, '2019_12_22_153334_create_user_types_table', 29);
...
--
-- Table structure for table `partenerships`
--

CREATE TABLE `partenerships` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `partent_id` bigint(20) UNSIGNED NOT NULL,
  `type` enum('inside','outside') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;

--
-- Dumping data for table `partenerships`
--

INSERT INTO `partenerships` (`id`, `user_id`, `partent_id`, `type`, `created_at`, `updated_at`) VALUES
(4, 66, 69, 'inside', '2019-12-18 06:48:23', '2019-12-18 06:48:23'),
(5, 65, 69, 'inside', '2019-12-18 06:52:14', '2019-12-18 06:52:14');
...
--
-- Table structure for table `permission_optionmemberships`
--

CREATE TABLE `permission_optionmemberships` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `permission_optionmemberships`
--

INSERT INTO `permission_optionmemberships` (`id`, `permision_id`, `membership_option_id`, `created_at`, `updated_at`) VALUES
(317, 1, 134, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(318, 2, 134, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(319, 3, 134, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(320, 25, 134, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(321, 26, 134, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(322, 1, 135, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(323, 2, 135, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(324, 3, 135, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(325, 25, 135, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(326, 26, 135, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(327, 1, 136, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(328, 2, 136, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(329, 3, 136, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(330, 25, 136, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(331, 26, 136, '2019-12-18 04:38:05', '2019-12-18 04:38:05'),
(332, 1, 137, '2019-12-18 04:38:06', '2019-12-18 04:38:06'),
(333, 2, 137, '2019-12-18 04:38:06', '2019-12-18 04:38:06'),
(334, 3, 137, '2019-12-18 04:38:06', '2019-12-18 04:38:06'),
(335, 25, 137, '2019-12-18 04:38:06', '2019-12-18 04:38:06'),
(336, 26, 137, '2019-12-18 04:38:06', '2019-12-18 04:38:06'),
(337, 1, 139, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(338, 2, 139, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(339, 3, 139, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(340, 4, 139, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(341, 7, 139, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(342, 9, 139, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(343, 11, 139, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(344, 1, 141, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(345, 2, 141, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(346, 3, 141, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(347, 4, 141, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(348, 7, 141, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(349, 9, 141, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(350, 11, 141, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(351, 1, 143, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(352, 2, 143, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(353, 3, 143, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(354, 4, 143, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(355, 7, 143, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(356, 9, 143, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(357, 11, 143, '2019-12-23 02:53:38', '2019-12-23 02:53:38'),
(358, 1, 144, '2019-12-23 02:53:39', '2019-12-23 02:53:39'),
(359, 2, 144, '2019-12-23 02:53:39', '2019-12-23 02:53:39'),
(360, 3, 144, '2019-12-23 02:53:39', '2019-12-23 02:53:39'),
(361, 4, 144, '2019-12-23 02:53:39', '2019-12-23 02:53:39'),
(362, 7, 144, '2019-12-23 02:53:39', '2019-12-23 02:53:39'),
(363, 9, 144, '2019-12-23 02:53:39', '2019-12-23 02:53:39'),
(364, 11, 144, '2019-12-23 02:53:39', '2019-12-23 02:53:39');
...
CREATE TABLE `sms` (
  ...
  `status` enum('pending','ok','fail') COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `sms` (`id`, `user_id`, `from_id`, `created`, `status`, `created_at`, `updated_at`) VALUES
(15, 69, 2, '12/22/2019', 'ok', '2019-12-20 02:44:24', '2019-12-20 05:24:15');

-- --------------------------------------------------------

--
-- Table structure for table `sms_datas`
--

CREATE TABLE `sms_datas` (
  `id` int(10) UNSIGNED NOT NULL,
...
--
-- Dumping data for table `sms_datas`
--

INSERT INTO `sms_datas` (`id`, `sms_id`, `message`, `lang_id`, `created_at`, `updated_at`) VALUES
(53, 15, '<p>dfdf</p>', 1, '2019-12-20 02:44:24', '2019-12-20 02:44:24'),
(54, 15, '<p>dfgdfgfdg</p>', 2, '2019-12-20 02:44:24', '2019-12-20 02:44:24'),
(55, 15, '<p>fdgfdbfgb</p>', 5, '2019-12-20 02:44:24', '2019-12-20 02:44:24'),
(56, 15, '<p>sdfsdfdsaf</p>', 6, '2019-12-20 02:44:24', '2019-12-20 02:44:24');
...
INSERT INTO `stories` (`id`, `published`, `user_id`, `created_at`, `updated_at`) VALUES
(42, 'false', 66, '2019-12-18 06:48:23', '2019-12-18 06:48:23'),
(43, 'true', 65, '2019-12-18 06:52:14', '2019-12-18 06:52:14');

-- --------------------------------------------------------

--
-- Table structure for table `story_datas`
--

CREATE TABLE `story_datas` (
  `id` int(10) UNSIGNED NOT NULL,
  `title` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `content` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `lang_id` bigint(20) UNSIGNED DEFAULT NULL,
...
--
-- Dumping data for table `story_datas`
--

INSERT INTO `story_datas` (`id`, `title`, `content`, `lang_id`, `stories_id`, `created_at`, `updated_at`) VALUES
(1, 'سامر', '<p>سامر</p>', 1, 42, '2019-12-18 06:48:23', '2019-12-18 06:48:23'),
(2, 'Samer', '<p>samer</p>', 2, 42, '2019-12-18 06:48:23', '2019-12-18 06:48:23'),
(3, 'samer fr', '<p>samer fr</p>', 5, 42, '2019-12-18 06:48:23', '2019-12-18 06:48:23'),
(4, 'samer po', '<p>samer pooo</p>', 6, 42, '2019-12-18 06:48:23', '2019-12-18 06:48:23'),
(5, 'جديدددد', '<p>جديد جديد</p>', 1, 43, '2019-12-18 06:52:14', '2019-12-19 23:28:25'),
(6, 'new', '<p>newm nrew</p>', 2, 43, '2019-12-18 06:52:14', '2019-12-19 23:28:25'),
(7, 'new fr', '<p>new fr</p>', 5, 43, '2019-12-18 06:52:14', '2019-12-19 23:28:25'),
(8, 'new po', '<p>new po</p>', 6, 43, '2019-12-18 06:52:14', '2019-12-19 23:28:25');
...
(2, 'admin', 'admin', '00000', 'male', NULL, 'admin@admin.com', '$2y$10$6V1tekmQDDYjz.mE6SkRleSPJQdattvr/U6b7Tbkoyvl7Kf3sRdkO', 'admin.com', 'date', 'admin', 'n9ACxH3UOljXmmuJA4nqNG2GZbxwBSHI1zhe7lB5.png', '25', 'asdasdsadas', 'sadadasdsadas', 0, 350, 105, 22, NULL, 'MLuKBbD3HlxqhsxNR1HWDQeSeMe6I8t56CXhMVECv6BgBOSPr6THRcQsrakz', '2019-09-05 06:44:55', '2019-12-23 02:55:09'),
...
(69, 'osam', 'ousama', '0038766789758', 'female', NULL, 'oussama16v@gmail.com', '$2y$10$fPdH9GYd683ZQvq5fAHB2.3I9BAc5xUEZY5oN/5gIsd5xTxkF4IIy', 'dddfggd', 'date', 'web', NULL, '27', 'ddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddddd', 'ddddddddddddddddddd', 1, 250, 10, 21, NULL, NULL, '2019-11-11 10:28:19', '2019-12-20 00:05:29'),
(70, 'samerabooda', 'samer', '42423423423', 'female', NULL, 'samerabdelmonem96@gmail.com', '$2y$10$UbzOixi414KyllZnJRtm8.yvnz3NXKUIhUBK.0WNmW1yHGPI6Q9qK', 'mit taher\r\nmansoura', 'date', 'web', NULL, '15', 'asdasdasdas', 'sadadsaas', 1, 290, 45, 25, 2, NULL, '2019-11-28 12:24:52', '2019-12-13 07:39:37'),
...
(1, 2, 'online', 'login', '2019-12-22 15:19:40', NULL, NULL),
...
(12, 2, 'login', '2019-12-22', NULL, NULL),
...
INSERT INTO `user_logins` (`id`, `user_id`, `active_data`, `created_at`, `updated_at`) VALUES
(1, 65, '2019-12-21', '2019-12-19 23:29:36', '2019-12-20 03:57:43'),
(2, 69, '2019-12-19', '2019-12-20 00:05:23', '2019-12-20 00:05:23'),
(3, 2, '2019-12-05', '2019-12-23 02:55:09', '2019-12-23 02:55:09');
...
CREATE TABLE `user_settings` (
  `id` int(10) UNSIGNED NOT NULL,
  `user_id` bigint(20) UNSIGNED NOT NULL,
  `json_setting` text COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user_settings` (`id`, `user_id`, `json_setting`, `created_at`, `updated_at`) VALUES
(8, 65, '[\"show-name\"]', '2019-12-24 05:39:27', '2019-12-24 05:41:54');
...
CREATE TABLE `user_story` (
  ...
  `type` enum('inside','outside') COLLATE utf8mb4_unicode_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user_story` (`id`, `created_at`, `updated_at`, `user_id`, `store_id`, `Partner_id`, `type`) VALUES
(3, '2019-12-18 06:48:23', '2019-12-18 06:48:23', 66, 42, 69, 'inside'),
(4, '2019-12-18 06:52:14', '2019-12-19 23:28:25', 65, 43, 69, 'outside');
...
CREATE TABLE `user_types` (
  ...
  `json_data` varchar(191) COLLATE utf8mb4_unicode_ci NOT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `user_types` (`id`, `type`, `json_data`, `created_at`, `updated_at`) VALUES
(7, 1, '[\"show-mobile\",\"show-name\",\"show-test\",\"show-tes1\"]', '2019-12-24 05:37:58', '2019-12-24 05:37:58'),
(8, 0, '[\"show-mobile\",\"show-test\",\"show-tes1\"]', '2019-12-24 05:38:12', '2019-12-24 05:38:57');
...
--
-- Indexes for table `membership_option_data`
--
ALTER TABLE `membership_option_data`
  ADD PRIMARY KEY (`id`),
  ADD KEY `membership_option_data_membership_option_id_foreign` (`membership_option_id`),
  ADD KEY `membership_option_data_lang_id_foreign` (`lang_id`);
...
--
-- Indexes for table `message_attaches`
--
ALTER TABLE `message_attaches`
  ADD PRIMARY KEY (`id`),
  ADD KEY `message_attaches_message_id_foreign` (`message_id`);
...
--
-- Indexes for table `partenerships`
--
ALTER TABLE `partenerships`
  ADD PRIMARY KEY (`id`),
  ADD KEY `partenerships_user_id_foreign` (`user_id`),
  ADD KEY `partenerships_partent_id_foreign` (`partent_id`);
...
--
-- Indexes for table `permission_optionmemberships`
--
ALTER TABLE `permission_optionmemberships`
  ADD PRIMARY KEY (`id`),
  ADD KEY `permission_optionmemberships_membership_option_id_foreign` (`membership_option_id`);
...
ALTER TABLE `role_settings`
  ADD PRIMARY KEY (`id`),
  ADD KEY `role_settings_role_id_foreign` (`role_id`),
  ADD KEY `role_settings_user_setting_id_foreign` (`user_setting_id`);
...
ALTER TABLE `sms`
  ...
  ADD KEY `sms_from_id_foreign` (`from_id`);

--
-- Indexes for table `sms_datas`
--
ALTER TABLE `sms_datas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `sms_datas_sms_id_foreign` (`sms_id`),
  ADD KEY `sms_datas_lang_id_foreign` (`lang_id`);
...
--
-- Indexes for table `story_datas`
--
ALTER TABLE `story_datas`
  ADD PRIMARY KEY (`id`),
  ADD KEY `story_datas_stories_id_foreign` (`stories_id`),
  ADD KEY `lang_id` (`lang_id`);
...
ALTER TABLE `transaction_types`
  ADD PRIMARY KEY (`id`),
  ADD KEY `transaction_types_transactions_id_foreign` (`transactions_id`);
...
--
-- AUTO_INCREMENT for table `membership_option_data`
--
ALTER TABLE `membership_option_data`
...
--
-- AUTO_INCREMENT for table `message_attaches`
--
ALTER TABLE `message_attaches`
...
--
-- AUTO_INCREMENT for table `partenerships`
--
ALTER TABLE `partenerships`
...
--
-- AUTO_INCREMENT for table `permission_optionmemberships`
--
ALTER TABLE `permission_optionmemberships`
...
--
-- AUTO_INCREMENT for table `sms_datas`
--
ALTER TABLE `sms_datas`
...
--
-- AUTO_INCREMENT for table `story_datas`
--
ALTER TABLE `story_datas`
...
--
-- Constraints for table `membership_option_data`
--
ALTER TABLE `membership_option_data`
  ADD CONSTRAINT `membership_option_data_lang_id_foreign` FOREIGN KEY (`lang_id`) REFERENCES `languages` (`id`),
  ADD CONSTRAINT `membership_option_data_membership_option_id_foreign` FOREIGN KEY (`membership_option_id`) REFERENCES `membership_options` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `message_attaches`
--
ALTER TABLE `message_attaches`
  ADD CONSTRAINT `message_attaches_message_id_foreign` FOREIGN KEY (`message_id`) REFERENCES `messages` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
-- Constraints for table `partenerships`
--
ALTER TABLE `partenerships`
  ADD CONSTRAINT `partenerships_partent_id_foreign` FOREIGN KEY (`partent_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `partenerships_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `permission_optionmemberships`
--
ALTER TABLE `permission_optionmemberships`
  ADD CONSTRAINT `permission_optionmemberships_membership_option_id_foreign` FOREIGN KEY (`membership_option_id`) REFERENCES `membership_options` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `role_settings`
  ADD CONSTRAINT `role_settings_role_id_foreign` FOREIGN KEY (`role_id`) REFERENCES `roles` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `role_settings_user_setting_id_foreign` FOREIGN KEY (`user_setting_id`) REFERENCES `user_settings` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `sms`
  ADD CONSTRAINT `sms_from_id_foreign` FOREIGN KEY (`from_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sms_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `sms_datas`
--
ALTER TABLE `sms_datas`
  ADD CONSTRAINT `sms_datas_lang_id_foreign` FOREIGN KEY (`lang_id`) REFERENCES `languages` (`id`),
  ADD CONSTRAINT `sms_datas_sms_id_foreign` FOREIGN KEY (`sms_id`) REFERENCES `sms` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Constraints for table `story_datas`
--
ALTER TABLE `story_datas`
  ADD CONSTRAINT `story_datas_ibfk_1` FOREIGN KEY (`lang_id`) REFERENCES `languages` (`id`),
  ADD CONSTRAINT `story_datas_stories_id_foreign` FOREIGN KEY (`stories_id`) REFERENCES `stories` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `transaction_types`
  ADD CONSTRAINT `transaction_types_transactions_id_foreign` FOREIGN KEY (`transactions_id`) REFERENCES `transactions` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `user_logins`
  ADD CONSTRAINT `user_logins_user_id_foreign` FOREIGN KEY (`user_id`) REFERENCES `users` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
