...
class CategoryDataTable extends DataTable
{
        ...
        return datatables($query)
            ->addColumn('edit', function ($query) {
                if (auth()->user()->can('category-edit')){
                    return '<button  data-id ="'.$query->id.'" data-name ="'.$query->name.'"  data-lang="'.$query->lang_id.'"  data-toggle="modal" data-target="#edit"  class="btn btn-sm btn-success edit"><i class="fa fa-edit"></i> ' . _i('edit') .'</button>';
                }else{
    ...
    {
        return Category::query()->where('lang_id','=',session('language'));
    }
