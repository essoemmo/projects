...
class material_statusDataTable extends DataTable
{
    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function ($query) {
                if (auth()->user()->can('materialStatus-Edit')){
                    return '<button  data-id ="'.$query->id.'" data-name ="'.$query->name.'" data-gender="'.$query->gender.'" data-lang="'.$query->lang_id.'"  data-toggle="modal" data-target="#edit"  class="btn btn-sm btn-success edit"><i class="fa fa-edit"></i> ' . _i('edit') .'</button>';
                }else{
                    return '<button  class="btn btn-sm btn-success disabled"><i class="fa fa-edit"></i> ' . _i('edit') .'</button>';

                }
            })
            ->addColumn('delete', 'admin.material_status.btn.delete')
            ->rawColumns([
                'edit',
                'delete',
            ]);
    ...
    {
            return Material_status::query()->where('source_id','=',null);
    }
...
//                    ],
    ...
    {
        return 'material_status_' . date('YmdHis');
    }
}
