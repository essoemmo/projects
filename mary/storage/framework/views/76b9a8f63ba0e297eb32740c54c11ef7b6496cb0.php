                            ...
                            <form action="<?php echo e(route('Stories.store')); ?>" method="post" id="addForm">
                                        ...
                                        <div class="tab-content" id="custom-tabs-two-tabContent">
                                            ...
                                            <div class="tab-pane <?php echo e($index == 0 ? 'active': ''); ?>" id="<?php echo e($lang->code); ?>" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <textarea name="<?php echo e($lang->code); ?>_conteent" class="form-control ckeditor"></textarea>
                                                </div>
                                            </div>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <input type="radio" name="type"  value="inside">
                                    </div>
                                    <div class="col-md-6">
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mary\resources\views/admin/stories/create.blade.php ENDPATH**/ ?>