    ...
    <nav aria-label="breadcrumb" class="breadcrumb-wrapper">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo e(_i('last member')); ?></li>
            </ol>
        </div>
    </nav>
    ...
    <section class="latest-members  common-wrapper ">
        <div class="container">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form action="" class="users-country-selection form-inline">
                            <label><?php echo e(_i('last member')); ?> </label>
                            <?php
            ...
            <div id="data">
                ...
                <?php echo $__env->make('web.user.latestUser.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('change','#country',function (e) {
                ...
                var val  = $(this).val();
                $.ajax({
                    url: '<?php echo e(route('get-latestUser-country')); ?>',
                    method: "get",
                    data: {val:val},
            ...
            $('body').on('click','#filter',function (e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('get-latestUser-filter')); ?>',
                    method: "get",
                    data: {filter:filter},
                    success: function (response) {
                        $('#data').html(response)
    ...
    <script>
        $(document).on('click','.pagination a' ,function(e){
            ...
            $.ajax({
                ...
                url:"/paginate/fetch/latest?page="+page,
...
<?php echo $__env->make('web.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/euzawaaj/public_html/beta/resources/views/web/user/latestUser/index.blade.php ENDPATH**/ ?>