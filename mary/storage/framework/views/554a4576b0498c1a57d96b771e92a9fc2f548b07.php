<?php if($activeUser->count() > 0): ?>

    <div class="row">

        <?php $__currentLoopData = $activeUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $active): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            ...
            <?php echo e($activeUser->appends(request()->query())->links()); ?>
...
<?php else: ?>
    <div class="alert alert-danger">
        <h4><?php echo e(_i('Sorry dont Found activeuser')); ?></h4>
    </div>
<?php endif; ?>

<?php /**PATH /home/euzawaaj/public_html/mary/resources/views/web/user/activeMember/ajax.blade.php ENDPATH**/ ?>