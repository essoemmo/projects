<?php if($bestUser->count() > 0): ?>

    <div class="row">

        <?php $__currentLoopData = $bestUser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $best): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

            <?php

            $usernat = \App\Models\User::select(['id','username','nationalty_id','city_id','age','gender','photo','guard','resident_country_id'])
                ->where('id', '=', $best->user_id)
                ->first();
    ...
    <nav aria-label="Page navigation example">
        <ul class="pagination justify-content-center">
            ...
            <?php echo e($bestUser->appends(request()->query())->links()); ?>
...
<?php /**PATH /home/euzawaaj/public_html/mary/resources/views/web/user/bestMemeber/ajax.blade.php ENDPATH**/ ?>