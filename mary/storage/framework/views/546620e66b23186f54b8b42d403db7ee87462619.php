    ...
    <nav aria-label="breadcrumb" class="breadcrumb-wrapper">
        <div class="container">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active" aria-current="page"><?php echo e(_i('onlineUser')); ?> </li>
            </ol>
        </div>
    </nav>
                ...
                <div class="row">
                    <div class="col-md-6">
                        <form action="" class="users-country-selection form-inline">
                            <label><?php echo e(_i('OnineUser')); ?> </label>
                            <?php
                    ...
                    <div class="col-md-6 align-self-md-center">
                        <div class="filter-btns text-left">
                            <button class="btn btn-default filter-button" id="filter" data-filter="all">الكل</button>
...
<?php echo $__env->make('web.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/euzawaaj/public_html/beta/resources/views/web/user/OnlineUser/index.blade.php ENDPATH**/ ?>