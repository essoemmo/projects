                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="center">
                                    ...
                                    <a href="<?php echo e(route('reset-password')); ?>" class="text-muted text-left d-block"><?php echo e(_i('forget the password')); ?></a>
                                </div>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('web.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/euzawaaj/public_html/beta/resources/views/web/user/login.blade.php ENDPATH**/ ?>