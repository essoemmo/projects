                    ...
                    <div class="col-sm-10">
                        <select class="form-control status" style="width: 100%;" name="material_status_id">
                            ...
                            <?php if($user->gender == 'male'): ?>
                                <?php $__currentLoopData = \App\Models\Material_status::where('gender','male')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matiral): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($matiral->id); ?>" <?php echo e($user->material_status_id == $matiral->id ? 'selected': ''); ?> ><?php echo e($matiral->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>

                            <?php else: ?>
                                <?php $__currentLoopData = \App\Models\Material_status::where('gender','female')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $matiral): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <option value="<?php echo e($matiral->id); ?>" <?php echo e($user->material_status_id == $matiral->id ? 'selected': ''); ?> ><?php echo e($matiral->name); ?></option>
                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            <?php endif; ?>
...
<br><br><br><?php /**PATH /home/euzawaaj/public_html/mary/resources/views/web/user/accountsetting/editProfile.blade.php ENDPATH**/ ?>