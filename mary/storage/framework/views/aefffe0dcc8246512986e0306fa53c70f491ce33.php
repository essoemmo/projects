                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="center">
                                    ...
                                    <a href="<?php echo e(url('/reset_password')); ?>" class="text-muted text-left d-block">هل نسيت كلمة المرور؟</a>
                                </div>
                            </div>
                        </div>
                    </form>
...
<?php echo $__env->make('web.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\beta\resources\views/web/user/login.blade.php ENDPATH**/ ?>