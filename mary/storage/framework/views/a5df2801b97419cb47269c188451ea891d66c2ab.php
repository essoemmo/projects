<?php if(auth()->user()->can('Feature-Delete')): ?>
<form action="<?php echo e(route('Features.destroy',$id)); ?>" method="post">
...
<?php /**PATH /home/euzawaaj/public_html/beta/resources/views/admin/features/optiongroup/btn/delete.blade.php ENDPATH**/ ?>