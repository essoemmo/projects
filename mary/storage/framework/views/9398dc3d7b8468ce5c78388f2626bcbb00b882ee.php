<?php if(auth()->user()->can('Membership-Delete')): ?>

<form action="<?php echo e(route('memberships.destroy',$id)); ?>" method="post">
...
<?php /**PATH /home/euzawaaj/public_html/beta/resources/views/admin/memberShip/btn/delete.blade.php ENDPATH**/ ?>