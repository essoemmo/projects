<?php if(auth()->user()->can('stories-delete')): ?>
<form action="<?php echo e(route('Stories.destroy',$id)); ?>" method="post">
...
<?php /**PATH /home/euzawaaj/public_html/beta/resources/views/admin/stories/btn/delete.blade.php ENDPATH**/ ?>