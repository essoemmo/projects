...
<?php $__env->startSection('content'); ?>
    ...
    <!-- /.box-header -->
        <div class="card-body table-responsive">
            <a href="<?php echo e(route('type-member-new')); ?>" class="btn btn-info btn-sm"><i class="fa fa-plus"></i><?php echo e(_i('add new')); ?></a>
    ...
    <script type="text/javascript">
        ...
        $(function() {
            ...
            var table = $('#setting_user').DataTable({
                ...
                serverSide: true,
                ajax: {
                    url: "<?php echo e(route('type-member')); ?>",
                    type: 'GET',
                },
                // select: true,
                columns: [
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mary\resources\views/admin/members/typeUser/index.blade.php ENDPATH**/ ?>