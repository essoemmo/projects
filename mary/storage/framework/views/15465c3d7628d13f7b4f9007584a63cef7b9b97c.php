...
<?php $__env->startSection('content'); ?>
    ...
    <!-- /.box-header -->
        <div class="card-body table-responsive">
            <button class="btn btn-primary create" data-toggle="modal" data-target="#create"><i class="fa fa-plus"></i><?php echo e(_i('material_status')); ?></button>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('material_status.store')); ?>" method="post" id="addForm">
                        ...
                        <div class="form-group">
                        <label><?php echo e(_i('gender')); ?></label>

                        <select name="gender" class="form-control">
                                <option value="male"><?php echo e(_i('male')); ?></option>
                                <option value="female"><?php echo e(_i('female')); ?></option>
                        </select>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('click','.edit',function (e) {
                ...
                var html = `<form action="<?php echo e(route('edit-material_status')); ?>"  method="post" id="formedit">
                    <?php echo csrf_field(); ?>
                    ...
                    <option value="<?php echo e($key); ?>" ><?php echo e($lang); ?></option>
                        ...
                        <select name="gender" class="form-control" id="gender_ax">
                                <option value="male"><?php echo e(_i('male')); ?></option>
                                <option value="female"><?php echo e(_i('female')); ?></option>
                        </select>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/euzawaaj/public_html/beta/resources/views/admin/material_status/index.blade.php ENDPATH**/ ?>