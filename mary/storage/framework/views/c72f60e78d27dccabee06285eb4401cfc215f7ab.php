...
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link">
        <?php if(settings()->loge != null): ?>
            <img src="<?php echo e(asset('uploads/setting/' . settings()->loge)); ?>" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
             style="opacity: .8">
        <?php else: ?>
            <img src="<?php echo e(url('/')); ?>/adminPanel/dist/img/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3"
                 style="opacity: .8">
        <?php endif; ?>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\beta\resources\views/admin/layouts/nav.blade.php ENDPATH**/ ?>