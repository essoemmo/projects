    ...
    <section class="latest-members  common-wrapper ">
        <div class="container">
            ...
            <div id="data">
                ...
                <?php echo $__env->make('web.user.bestMemeber.ajax', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
...
<?php $__env->startPush('js'); ?>
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('change', '#country', function (e) {
                ...
                var val = $(this).val();
                $.ajax({
                    url: '<?php echo e(route('get-bestUser-country')); ?>',
                    method: "get",
                    data: {val: val},
            ...
            $('body').on('click','#filter',function (e) {
                ...
                $.ajax({
                    url: '<?php echo e(route('get-bestUser-filter')); ?>',
                    method: "get",
                    data: {filter:filter},
                    success: function (response) {
                        $('#data').html(response)
    ...
    <script>
        $(document).on('click','.pagination a' ,function(e){
            ...
            $.ajax({
                url:"/paginate/fetch/best?page="+page,
...
<?php echo $__env->make('web.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/euzawaaj/public_html/mary/resources/views/web/user/bestMemeber/index.blade.php ENDPATH**/ ?>