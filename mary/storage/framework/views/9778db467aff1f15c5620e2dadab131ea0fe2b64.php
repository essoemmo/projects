            ...
            <div class="card card-default">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <form method="post" action="<?php echo e(route('setting-member-update',$editSetting->id)); ?>" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="user_id" class="form-control selectpicker">
                                        <?php $__currentLoopData = \App\Models\User::where('guard','!=','admin')->get(); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $membership): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($membership->id); ?>" <?php echo e($editSetting->user_id == $membership->id ? 'selected' : ''); ?> ><?php echo e($membership->username); ?></option>
                                                ...
                                                <?php $__currentLoopData = json_decode($dat->json_data); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $da): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <div class="col-md-4">
                                                        <div class="">
                                                            ...
                                                            <input type="checkbox" name="options[]" class="" value="<?php echo e($da); ?>" <?php echo e(in_array($da,$options) ? "checked":""); ?>>
                                                        </div>
                                                        <br>
                                                    </div>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mary\resources\views/admin/members/userSetting/edit.blade.php ENDPATH**/ ?>