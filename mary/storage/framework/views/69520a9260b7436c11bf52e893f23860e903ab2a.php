                                ...
                                <ul class="list-inline single-member-options">
                                    ...
                                    <?php if(\Illuminate\Support\Facades\Auth::check()): ?>
                                        ...
                                        <?php if(!empty($fav) && $fav->action == 'like' && $fav->from_id == auth()->user()->id ): ?>
                                            <li><a href="javascript:void(0)"  class="add-to-fav-online" id="<?php echo e('like-'.$usernat->id); ?>" data-id="<?php echo e($usernat->id); ?>"  data-to="<?php echo e($usernat->id); ?>" data-from="<?php echo e(\Illuminate\Support\Facades\Auth::id() ? \Illuminate\Support\Facades\Auth::id() : ''); ?>" title="اضافه لقائمة الاهتمام"><i class="fa fa-heart"></i></a></li>
                                        <?php else: ?>
                                            <li><a href="javascript:void(0)"  class="add-to-fav-online" id="<?php echo e('like-'.$usernat->id); ?>" data-id="<?php echo e($usernat->id); ?>" data-to="<?php echo e($usernat->id); ?>" data-from="<?php echo e(\Illuminate\Support\Facades\Auth::id() ? \Illuminate\Support\Facades\Auth::id() : ''); ?>"><i class="fa fa-heart-o"></i></a></li>
                                        <?php endif; ?>

                                    <?php else: ?>
                                        <?php if(!empty($fav) && $fav->action == 'like'): ?>
                                            <li><a href="javascript:void(0)"  class="add-to-fav-online" id="<?php echo e('like-'.$usernat->id); ?>" data-id="<?php echo e($usernat->id); ?>"  data-to="<?php echo e($usernat->id); ?>" data-from="<?php echo e(\Illuminate\Support\Facades\Auth::id() ? \Illuminate\Support\Facades\Auth::id() : ''); ?>" title="اضافه لقائمة الاهتمام"><i class="fa fa-heart-o"></i></a></li>
                                        <?php else: ?>
                                            <li><a href="javascript:void(0)"  class="add-to-fav-online" id="<?php echo e('like-'.$usernat->id); ?>" data-id="<?php echo e($usernat->id); ?>" data-to="<?php echo e($usernat->id); ?>" data-from="<?php echo e(\Illuminate\Support\Facades\Auth::id() ? \Illuminate\Support\Facades\Auth::id() : ''); ?>"><i class="fa fa-heart-o"></i></a></li>
                                        <?php endif; ?>
...
<?php /**PATH /home/euzawaaj/public_html/mary/resources/views/web/user/OnlineUser/ajax.blade.php ENDPATH**/ ?>