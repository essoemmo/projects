                        ...
                        <div class="col-md-12">
                            ...
                            <form method="post" id="addForm" enctype="multipart/form-data" data-parsley-validate>
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" id="datepicker"  name="created" class="form-control" required="">
                                </div>
                                            ...
                                            <div class="tab-content" id="custom-tabs-two-tabContent">
                                                ...
                                                <div class="tab-pane <?php echo e($index == 0 ? 'active' : ''); ?>" id="<?php echo e($lang->code); ?>" role="tabpanel" aria-labelledby="custom-tabs-two-home-tab">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="<?php echo e($lang->code); ?>_message" class="form-control ckeditor"></textarea>
                                                    </div>
...
<?php $__env->startPush('js'); ?>
    ...
    <script type="text/javascript">
        ...
        $('body').on('submit','#addForm',function (e) {
            e.preventDefault();
            $.ajax({
                url: '<?php echo e(route('sms.store')); ?>',
                method: "post",
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\mary\resources\views/admin/setting/sms/create.blade.php ENDPATH**/ ?>