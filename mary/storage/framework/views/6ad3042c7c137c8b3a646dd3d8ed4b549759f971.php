    ...
    <div class="top-header">
                            ...
                            <a class="nav-link dropdown-toggle" href="#" role="button"
                               data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                $language = \App\Models\Language::where('id',session('language'))->first();
                                   ?>
                                <img src='<?php echo e(asset("web/images/$language->code.png")); ?>' alt="" style="width: 23px;height: 23px;">
        ...
        <div class="container">
            ...
            <nav class="navbar navbar-expand-lg navbar-light">
                ...
                <a href="<?php echo e(url('/')); ?>" class="navbar-brand"><img data-src="<?php echo e(asset('uploads/setting/'.settings()->loge)); ?>" alt="" class="img-fluid lazy"></a>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item <?php echo e(request()->segment(1) == "LatestUser" ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(route('get-latestUser')); ?>"><?php echo e(_i('Latest Members')); ?></a>
                        </li>
                        <li class="nav-item <?php echo e(request()->segment(1) == "bestUser" ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(route('get-bestUser')); ?>"><?php echo e(_i('BestMember')); ?></a>
                        </li>
                        <li class="nav-item <?php echo e(request()->segment(1) == "active" ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(route('get-activeUser')); ?>"><?php echo e(_i('Active Members')); ?></a>
                        </li>

                        <li class="nav-item <?php echo e(request()->segment(1) == "stories" ? 'active' : ''); ?>">
                            <a class="nav-link" href="<?php echo e(route('get-story')); ?>"><?php echo e(_i('successful Story')); ?></a>
                        </li>

                        <?php if(auth()->check()): ?>
                            <li class="user-profile list-inline-item dropdown nav-item <?php echo e(request()->segment(1) == "profile" ? 'active' : ''); ?>">
                        ...
                        <?php else: ?>
                            ...
                            <li class="nav-item <?php echo e(request()->segment(1) == "login" ? 'active' : ''); ?>" ><a href="<?php echo e(url('/login')); ?>" class="nav-link"> <?php echo e(_i('Login')); ?> </a></li>
                            <li class="nav-item <?php echo e(request()->segment(1) == "register" ? 'active' :''); ?>"><a href="<?php echo e(url('/register')); ?>" class="nav-link"> <?php echo e(_i('Register')); ?> </a></li>
        ...
        <div class="container">
            ...
            <ul class="footer-list list-inline ">
                <li class="list-inline-item">
                    ...
                    <li class="list-inline-item">
                        <a class="nav-link" href="<?php echo e(route('get-article')); ?>"><?php echo e(_i('Article')); ?></a>
                    </li>
            ...
            <div class="subscripe">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('store-subscript')); ?>" method="post" data-parsley-validate="">
                  ...
                  right: 335px;">
                    <br>
                    <input type="submit" class="btn btn-grad animated fadeInDown" value="<?php echo e(_i('subscribe')); ?>">
                </form>
...
<?php /**PATH /home/euzawaaj/public_html/mary/resources/views/web/layout/master.blade.php ENDPATH**/ ?>