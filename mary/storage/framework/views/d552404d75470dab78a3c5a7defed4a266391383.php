...
<?php $__env->startSection('content'); ?>
    ...
    <!-- /.box-header -->
        <div class="card-body table-responsive">
            <?php if(auth()->user()->can('Feature-Add')): ?>
            <button class="btn btn-primary create" data-toggle="modal" data-target="#create"><i class="fa fa-plus"></i><?php echo e(_i('create_options')); ?></button>
             <?php endif; ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('Features.store')); ?>" method="post" id="addForm">
    ...
    <script>
        $(document).ready(function () {
            ...
            $('body').on('click','.edit',function (e) {
                ...
                var html = `<form action="<?php echo e(route('edit-Features')); ?>"  method="post" id="formedit">
                    <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/euzawaaj/public_html/beta/resources/views/admin/features/optiongroup/index.blade.php ENDPATH**/ ?>