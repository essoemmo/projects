...
?>
    ...
    <div class="my-messages-page common-wrapper">
        <div class="container">
            ...
            <strong><?php echo e(_i('message')); ?></strong> :  <?php echo e($massege->message); ?>

            </div>
            <br>
            <?php
            $replaymass = \App\Models\Message::
            where('massege_id',$massege->id)
...
<?php echo $__env->make('web.layout.master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/euzawaaj/public_html/beta/resources/views/web/user/replayMass.blade.php ENDPATH**/ ?>