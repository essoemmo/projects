...
use App\DataTables\FamousAdsDataTable;
...
class FamousAdsController extends Controller
{
    ...
    public function index(FamousAdsDataTable $famousAdsDataTable)
    {
        return $famousAdsDataTable->render('admin.famous_ads.index');
    }
    ...
    public function show($id)
    {
        ...
        return view('admin.famous_ads.show',compact('order','transaction','user','famous_ad','userAdRate'));
    }
