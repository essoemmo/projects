...
use App\Models\ContentSectionAdvertisement;
...
//            ->where('locale',App::getLocale())->pluck('countries_translations.title','countries.id');
    ...
    public function store(Request $request)
    {
        ...
        if ($request->product_id != null) {
            for ($ii = 0; $ii < count($request->product_id); $ii++) {
                ...
                ContentSectionAdvertisement::create([
    ...
    public function edit($id)
    {
        ...
        $section_product = ContentSectionAdvertisement::where('content_section_id', $content->id)->get();
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($request->product_id != null) {
            ContentSectionAdvertisement::where('content_section_id', $content->id)->delete();
            for ($ii = 0; $ii < count($request->product_id); $ii++) {
                $product_id = $request->product_id[$ii];
                $section_id = $content->id;
                ContentSectionAdvertisement::create([
