    ...
    <div class="row">
        ...
        <div class="col-sm-12 mbl">
            <span class="pull-left">
                  <a href="{{url('admin/permission/add')}}" data-toggle="modal" data-target="#create"
                     class="btn btn-primary create add-permission">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{\LaravelLocalization::localizeURL('admin/permission/add')}}" method="post"
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $('body').on('click', '.edit', function (e) {
                ...
                var html = `<form  action="{{ \LaravelLocalization::localizeURL('admin/permission/update') }} " method="post" class="form-horizontal"  id="formedit" data-parsley-validate="">
