...
<span class="preheader"
      style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">{{ _i('Thanks for trying out') }} {{ setting()->title }}.</span>
                                ...
                                <td class="content-cell"
                                    ...
                                    <div class="f-fallback">
                                        <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;"
                                            align="left">{{ _i('Welcome') }} {{ $data['user']->first_name }} {{ $data['user']->last_name }}
                                            ,</h1>
                            ...
                            <tr>
                                <td class="content-cell" align="center"
                                    ...
                                    <p class="f-fallback sub align-center"
                                       ...
                                       align="center">© {{ now()->year }} {{ setting()->title }}
                                        . {{ _i('All rights reserved') }}.</p>
                                    <p class="f-fallback sub align-center"
                                       style="font-size: 13px; line-height: 1.625; text-align: center; color: #A8AAAF; margin: .4em 0 1.1875em;"
                                       align="center">
                                        {{ setting()->address }}
