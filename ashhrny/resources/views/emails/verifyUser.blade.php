...
<span class="preheader" style="display: none !important; visibility: hidden; mso-hide: all; font-size: 1px; line-height: 1px; max-height: 0; max-width: 0; opacity: 0; overflow: hidden;">{{ _i('Thanks for trying out') }} @if(setting() != null) {{ setting()->title }}. @endif</span>
                            ...
                            <tr>
                                <td class="content-cell" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 35px;">
                                    <div class="f-fallback">
                                        <h1 style="margin-top: 0; color: #333333; font-size: 22px; font-weight: bold; text-align: left;" align="left">{{ _i('Welcome') }} {{ $data['user']->first_name }} {{ $data['user']->last_name }},</h1>
                                        <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">
                                            @php

                                                $search  = array("{userFirstName}","{userLastName}" ,"{userEmail}","{siteName}","{code}");
                                                $replace = array($data['user']->first_name, $data['user']->last_name, $data['user']->email, setting()->title, $data['user']->verifyUser->code);

                                                $output = str_replace($search, $replace, $data['body']);

                                            @endphp

                                            {!!  $output !!}
                                        </p>
                                        <p style="font-size: 16px; line-height: 1.625; color: #333; margin: .4em 0 1.1875em;">{{ _i('Thanks') }},
                                            <br />{{ $data['from_email'] }} {{ _i('and the') }} @if(setting() != null) {{ setting()->title }} @endif {{ _i('Team') }}</p>
                                    </div>
                                </td>
                            </tr>
                        </table>
                        ...
                        <table class="email-footer" align="center" width="570" cellpadding="0" cellspacing="0" role="presentation" style="width: 570px; -premailer-width: 570px; -premailer-cellpadding: 0; -premailer-cellspacing: 0; text-align: center; margin: 0 auto; padding: 0;">
                            <tr>
                                <td class="content-cell" align="center" style="word-break: break-word; font-family: &quot;Nunito Sans&quot;, Helvetica, Arial, sans-serif; font-size: 16px; padding: 35px;">
                                    <p class="f-fallback sub align-center" style="font-size: 13px; line-height: 1.625; text-align: center; color: #A8AAAF; margin: .4em 0 1.1875em;" align="center">© {{ now()->year }} @if(setting() != null) {{ setting()->title }}. @endif {{ _i('All rights reserved') }}.</p>
