                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-10">
                                                    <textarea name="{{ $lang->locale }}_content"
                                                              ...
                                                              @if($key == 0)required @endif></textarea>
                                                </div>
                                            </div>
                                            <hr>
            ...
            <div class="col-sm-4">
                                ...
                                @if(count($categories) > 0)
                                    <select class="form-control" name="category_id" required="">
                                        ...
                                        @foreach($categories as $category)
                                            <option
                                                value="<?=$category['id']?>" <?=old('lang_id') == $category['id'] ? 'selected' : ''?> ><?=_i($category['title'])?></option>
                                        @endforeach
                                    </select>
                ...
                <div class="card-block">
                    <div class="card">
                        ...
                        <div class="card-block">
                            <div class="row form-group">
                                <select class="selectpicker form-control" data-tags="true"
