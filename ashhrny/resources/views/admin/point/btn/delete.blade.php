...
<a href="points/{{$id}}/edit" target="_blank" class="btn btn-success edit" data-id="{{$id}}"><i class="ti-pencil-alt"></i></a>

{{--<a class="btn btn-danger waves-effect waves-light remove-record" data-toggle="modal" data-url="{{ \Illuminate\Support\Facades\URL::route('points.destroy', $id) }}" data-id="{{$id}}" data-target="#custom-width-modal"><i class="ti-trash" style="color: #fff;"></i></a>--}}
