...
@section('content')
    ...
    <div class="card">
        ...
        <div class="card-block">
            <form role="form" class="j-forms" action="{{route('section_products.update',$content->id)}}" method="post"
                    ...
                    @foreach($languages as $lang)
                        <div class="form-group">
                            ...
                            <input type="text" name="{{ $lang->locale }}_title" id="title"
                                   value="{{ $contents_title->where('locale' ,$lang->locale )->first()['title'] }}"
                                   class="form-control" required data-validate="true">
