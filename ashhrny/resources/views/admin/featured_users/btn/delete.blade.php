...
<a href="featured_users/{{$id}}"  class="btn btn-success edit"  ><i class="ti-eye"></i></a>
<a class="btn btn-danger waves-effect waves-light remove-record" data-toggle="modal" data-url="{{ \Illuminate\Support\Facades\URL::route('featured_users.destroy', $id) }}" data-id="{{$id}}" data-target="#custom-width-modal"><i class="ti-trash" style="color: #fff;"></i></a>
...
<script>
    $(function () {
        ...
        $('.change_status').on('click', function (e) {
            ...
            $.ajax({
                url:"{{ url('/admin/featured_users/') }}/" + row_id + "/change",
                DataType:'json',
                type:'get',
