                    ...
                    <form id="add_form" class="j-forms" enctype="multipart/form-data" data-parsley-validate="">
                        ...
                        <div class="content">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" class="form-control form-control-round country_logo" required
                                           name="image">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" class="form-control" name="code"
                                           placeholder="{{ _i('Bank Number') }}" required>
                                </div>
                            </div>
                    ...
                    <form id="edit_form" class="j-forms" enctype="multipart/form-data" data-parsley-validate="">
                        ...
                        <div class="content">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">{{ _i('Bank Number') }}</label>
                                <div class="col-sm-10">
                                    <input type="text" class="form-control bank_number" name="code"
                                           placeholder="{{ _i('Bank Number') }}" required>
                                </div>
                            </div>
