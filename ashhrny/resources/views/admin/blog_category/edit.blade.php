                ...
                <div class="row form-group">
                    <div class="col-lg-12">
                                ...
                                <div class="tab-pane @if ($loop->first) active @endif" id="{{ $lang->locale }}"
                                    ...
                                    <div class="clone-leftside-btn-2 cloneya-wrap">
                                        <div class="unit toclone-widget-left toclone cloneya">
                                            <div class="input">
                                                <input type="text"
                                                       value="{{ $blog_category->translate($lang->locale)->title }}"
                            ...
                            <div class="checkbox-fade fade-in-primary">
                                <label>
                                    ...
                                    <input type="checkbox" name="main" value="1"
                                           {{$blog_category->main == 1 ? 'checked' : ''}} id="main_checked">
                        ...
                        <div class="tab-content card-block">
                            <div class="form-group row">
                                <div class="col-md-12">
                                    <img class="img-fluid pad" style="width: 150px"
                                         src="{{ asset($blog_category->image) }}" id="image">
                                </div>
                            </div>
                        </div>
