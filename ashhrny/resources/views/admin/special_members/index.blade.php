...
'title' => _i('All Special Members'),
'activePageName' => _i('All Special Members'),
] )
@section('content')
    <div class="card">
                            ...
                            <form id="add_form" class="j-forms" enctype="multipart/form-data" data-parsley-validate="">
                                <div class="content">
                                    ...
                                    <div class="divider-text gap-top-45 gap-bottom-45">
                                        <span>{{ _i('Choose Special Member') }}</span>
                                    </div>
    ...
    <script>
        ...
        $(function () {
            $('#add_form').submit(function (e) {
                ...
                $.ajax({
                    url: "{{route('spcial_members.store')}}",
                    type: "post",
                    //data:form,
