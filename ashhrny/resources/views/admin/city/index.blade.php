                    ...
                    <form id="add_form" class="j-forms" data-parsley-validate="">
                        ...
                        <div class="content">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-10 ">
                                    <select class="form-control col-sm-12 country" name="country_id" required="">
                                        <option disabled="disabled">{{_i('Select Country')}}</option>
                    ...
                    <form id="edit_form" class="j-forms" enctype="multipart/form-data" data-parsley-validate="">
                        ...
                        <div class="content">
                            ...
                            <div class="form-group row">
                                <label class="col-sm-2 col-form-label">{{ _i('Country') }}</label>
                                <div class="col-sm-10 ">
                                    <select class="form-control col-sm-12 edit_country_id" name="country_id"
                                            required="">
                                        <option disabled="disabled">{{_i('Select Country')}}</option>
                                        @foreach($countries as $country)
                                            <option value="{{$country->id}}">{{$country['title']}}</option>
