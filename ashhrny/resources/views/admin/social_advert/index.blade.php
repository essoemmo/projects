...
'title' => _i('All Social Advertisement'),
'activePageName' => _i('All Social Advertisement'),
] )
@section('content')
    <div class="card">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-12">
                                            <div class="form-group row">
                                                <div class="col-sm-6">
                                                    <div class="row">
                                                        <label class="col-form-label">{{ _i('Type') }}</label>
                                                        <div class="col-sm-12">
                                                            <select name="type" id="add_type">
                                                                <option disabled selected>{{ _i('Select') }}</option>
                                                                <option
                                                                    value="website">{{ _i('Website Socials') }}</option>
                                                                <option
                                                                    value="user">{{ _i('Famous User Socials') }}</option>
                                                            </select>
                                                        </div>
                                                    </div>
                                                </div>
