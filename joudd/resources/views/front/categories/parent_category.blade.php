                                ...
                                <div class="single-category-box text-center d-flex flex-column">
                                    ...
                                    <div class="course-thumbnail">
                                        <a href="{{ url('category', $category->id) }}">
                                            <img data-src="{{asset('front/images/a-clinician-works-with-patients-in-a-health-setting.png')}}" alt=""
                    ...
                    <div class="col-lg-4 col-md-6 d-flex ">
                        <div class="single-category-box text-center d-flex flex-column">
                            <div class="course-thumbnail">
                                ...
                                <div class="caption">
                                    <h3 class="title"><a href="">{{_i('Course title here')}}</a></h3>
                                    <div class="courses-counter"> {{_i('no. courses')}}</div>
                                </div>
                            </div>
                        </div>
                    </div>
