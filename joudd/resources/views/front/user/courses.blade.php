                    ...
                    <div class="col-lg-4 col-md-6 d-flex ">
                        <div class="single-course-wrapper text-center d-flex flex-column">
                            ...
                            <div class="top-floating-icons d-flex justify-content-between left">
                                ...
                                @if(\App\Hr\Course\Course::findOrFail($course->course_id)->isFavorited())
                                    <a href="javascript:void(0)" class="add-to-fav" data-id="{{$course->course_id}}" style="margin-right:300px;">
...
{{--                                <div class="course-price"> {{$course->cost}} {{ $course->currency->title }}</div>--}}
{{--                                <span class="offer">10% <span>OFF</span></span>--}}
                            ...
                            <h3 class="title"><a href="{{ url('course', $course->course_id) }}">{{ $course->title }}</a></h3>
                            ...
                            <div class="d-flex justify-content-center">
                                ...
                                <a href="{{ url('course', $course->course_id) }}" class="btn btn-light btn-more">{{ _i('More') }}</a>
                            </div>
