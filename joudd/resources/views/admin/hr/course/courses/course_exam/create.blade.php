...
@section('content')
    ...
    <div class="box box-info">
        ...
        <!-- /.box-header -->
        <div class="box-body">
            <form method="POST" action="{{ url('/admin/course/'.$course->id.'/course_exam/store') }}" class="form-horizontal" id="demo-form" enctype="multipart/form-data" data-parsley-validate="">
                @csrf
