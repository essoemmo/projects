...
<form class="form-horizontal" action="<?= route('update_question') ?>" method="POST" id="form_2" data-parsley-validate="">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input id="title_1" type="text" class="form-control" name="title" placeholder="{{ _i('Title') }}" required="" /> @if ($errors->has('title'))
        ...
        <!-- =========== is_Required ============== -->
        <div class="checkbox">
            <label for="is_required" class=""> <input id="is_required_1" type="checkbox" class="checkbox" name="is_required">
...
<form class="form-horizontal" action="<?= route('create_question') ?>" method="POST" id="form_1" data-parsley-validate="">
    ...
    <div class="box-body">
        ...
        <div class="form-group">
            ...
            <div class="col-xs-6">
                <input id="title" type="text" class="form-control" name="title" required="" /> @if ($errors->has('title'))
                <span class="invalid-feedback" role="alert">
                    <strong>{{ $errors->first('title') }}</strong>
                </span> @endif
            </div>
        ...
        <div class="checkbox">
            <label for="is_multi" class="">
                <input id="is_multi" type="checkbox" class="check-box" name="is_multi" />
                {{ _i("Is Multi") }}
            </label>
            @if ($errors->has('is_multi'))
            <span class="invalid-feedback" role="alert">
        ...
        <div class=" checkbox">
            <label for="is_required" class="">
                <input id="is_required" type="checkbox" class="checkbox" name="is_required">
                {{ _i("Is Required") }}
            </label>
            @if ($errors->has('is_required'))
            <span class="invalid-feedback" role="alert">
...
<div class="box box-info">
    ...
    <script type="text/javascript">
        $(document).ready(
            ...
            processing: true,
            serverSide: true,
            ajax: '{{route("getData_course_question")}}',
            columns: [{
                    data: "id"
                }, {
                    data: "title"
