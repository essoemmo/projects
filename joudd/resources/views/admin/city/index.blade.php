...
@section('jobtype_edit_form')
    <form  class="form-horizontal" action="{{url('/admin/city/update')}}"  method="POST" class="form-horizontal"  id="form_2" data-parsley-validate="">
        @csrf
        <div class="box-body">
...
@section('job_type_form')
    <form  class="form-horizontal" action="{{url('/admin/city/store')}}" method="POST" class="form-horizontal"  id="form_1" data-parsley-validate="">
        @csrf
        <div class="box-body">

            <!-- ================================== language =================================== -->
            <div class="form-group row" >
                <label class="col-xs-3 col-form-label " for="lang_id">
                    {{_i('Language')}} </label>
                <div class="col-xs-8">
            ...
            <div class="form-group row">
                ...
                <div class="col-xs-8">
                    <select required="" id="get_country" class="form-control select2 select2-hidden-accessible" style="width:100%" aria-hidden="true" name="country_id" id="country_id">
