...
<a href="../offline/{{$id}}/show" target="_blank" class=" btn btn-icon waves-effect waves-light btn-primary" title="{{_i('Show')}}"><i class="fa fa-eye"></i></a>
<a href="../offline/{{$id}}/accept" class=" btn btn-icon waves-effect waves-light btn-info" title="{{_i('Accept')}}">
