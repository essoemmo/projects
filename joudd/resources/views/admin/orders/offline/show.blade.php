...
@section('page_header')
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li ><a href="{{url('/admin/orders/offline/all')}}">{{_i('All')}}</a></li>
        </ol>
    </section>
@endsection
  ...
  <div class="box box-info">
    ...
    <div class="row" style="padding:20px;">
        ...
        <div class="col-xs-6" style="border: 1px solid rgba(193,193,193,0.36); border-radius: 8px; padding: 10px; margin: 1.3rem !important; display: block;">
                ...
                <div class="box-body">
                    <div class="form-group">
                        <label class="control-label col-xs-4">{{_i('Bank Name')}}</label>
                        <p class="form-control-static col-xs-8">{{$bank["title"]}}</p>
                    </div>
                    <div class="form-group">
                        <label class="control-label col-xs-4">{{_i('Transaction No')}}</label>
                        <p class="form-control-static col-xs-8">{{$transaction["transaction_no"]}}</p>
                    </div>
                    <div class="form-group">
      ...
      <div class="box-footer">
          <a href="{{url('admin/orders/offline/'.$transaction["id"].'/accept')}}">
              <button type="button" class="btn btn-info "> <i class="fa fa-check-square-o"></i> {{ _i('Accept Transaction') }}</button>
          </a>
          <a href="{{url('admin/orders/offline/'.$transaction["id"].'/refused')}}">
              <button type="button" class="btn btn-danger "> <i class="fa fa-remove"></i> {{ _i('Refused') }}</button>
          </a>
...
{{--              <i class="fa fa-trash"></i>  {{_i('Delete')}} </a>--}}
    ...
    <form action="" method="POST" class="remove-record-model">
        <input type="hidden" value="offline" name="type" >
