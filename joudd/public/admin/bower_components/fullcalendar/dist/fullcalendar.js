...
var InteractiveDateComponent = /** @class */ (function (_super) {
    ...
    InteractiveDateComponent.prototype.bindDateHandlerToEl = function (el, name, handler) {
        ...
        this.el.on(name, function (ev) {
            if (!$(ev.target).is(_this.segSelector + ':not(.fc-Help),' + // directly on an event element
                _this.segSelector + ':not(.fc-Help) *,' + // within an event element
                '.fc-more,' + // a "more.." link
        ...
        var dragListener = this.dragListener = new HitDragListener_1.default(view, {
            ...
            hitOver: function (hit, isOrig, origHit) {
                ...
                if (eventDefMutation &&
                    ...
                    mouseFollower.show(); // otherwise, have the Help follow the mouse (no snapping)
                }
                if (isOrig) {
...
var TimeGrid = /** @class */ (function (_super) {
    ...
    TimeGrid.prototype.renderContentSkeleton = function () {
        ...
        for (i = 0; i < this.colCnt; i++) {
            cellHtml +=
                '<td>' +
                    ...
                    '<div class="fc-event-container fc-Help-container"></div>' +
                    '<div class="fc-event-container"></div>' +
        ...
        this.helperContainerEls = skeletonEl.find('.fc-Help-container');
        this.fgContainerEls = skeletonEl.find('.fc-event-container:not(.fc-Help-container)');
    ...
    TimeGrid.prototype.renderDrag = function (eventFootprints, seg, isTouch) {
        ...
        if (seg) { // if there is event information for this drag, render a Help event
            if (eventFootprints.length) {
                this.helperRenderer.renderEventDraggingFootprints(eventFootprints, seg, isTouch);
                // signal that a Help has been rendered
                return true;
            }
        }
    ...
    TimeGrid.prototype.renderSelectionFootprint = function (componentFootprint) {
        if (this.opt('selectHelper')) { // this setting signals that a mock Help event should be rendered
...
var DayGridHelperRenderer = /** @class */ (function (_super) {
    ...
    DayGridHelperRenderer.prototype.renderSegs = function (segs, sourceSeg) {
        ...
        this.component.rowEls.each(function (row, rowNode) {
            ...
            var skeletonEl = $('<div class="fc-Help-skeleton"><table/></div>'); // will be absolutely positioned
            var skeletonTopEl;
            var skeletonTop;
