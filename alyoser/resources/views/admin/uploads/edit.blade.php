            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="widget p-lg">
                        ...
                        <form action="{{route('uploads.update',$upload->id)}}" method="post" style="padding: 20px">
                            {{csrf_field()}}
                            {{method_field('put')}}
                            <div class="box-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="" name="name" value="{{$upload->name}}"
                                           placeholder="الاسم">
                                </div>

                                <div class="form-group">
                                    <label for="">الرقم التسلسلي</label>
                                    <input type="text" class="form-control" id="" name="uploadNumber" value="{{$upload->uploadNumber}}"
                                ...
                                <div class="form-group" id="showSubCat" style="display: none">
                                    <label for="">القسم الفرعي</label>
...
@push('js')
    <script>
        ...
        $(function () {
            ...
            $('body').on('change','#sub_category_id',function (e) {
                e.preventDefault();
            ...
            setTimeout(function(){
                $('#sub_category_id').val({{$upload->subCat}});
                $('#sub_category_id').trigger('change');
            }, 2000);

              setTimeout(function(){
         $('#sub_cat_id').val({{$upload->subnewCat}});
            }, 2000);
