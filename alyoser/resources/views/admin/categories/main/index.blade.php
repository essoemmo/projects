    ...
    <div class="col-md-12">
        <div class="widget">
            <header class="widget-header">
                <h4 class="widget-title">الاقسام الرئيسية</h4>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    @else
                                        ...
                                        <button type="button" style="float: left" class="btn btn-info btn-sm disabled">
                                            <i class="fa fa-plus"></i>
                                            اضافة جديد
                                        </button>
                                        @endif
                         ...
                         @method('post')
                                        <div class="modal-body">
                                               ...
                                               <div class="form-group">
                                                   ...
                                                   <input type="text" name="name" required="" class="form-control" style="width: 505px">
                                               </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <form id="editform" method="post" data-parsley-validate>
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group">
                                                <lable for="name">الاسم</lable>
                                                <input type="text" name="name" id="name" required="" class="form-control" style="width: 505px">
                                            </div>
