...
<nav class="navbar header-navbar pcoded-header" header-theme="theme4">
    <div class="navbar-wrapper">
        <div class="navbar-logo">
            ...
            <a href="index.html">
                <img class="img-fluid" src="{{asset('admin2/assets/images/logo.png')}}" alt="Theme-Logo" />
            </a>
                        ...
                        <ul class="show-notification row">
                            ...
                            <li class="col-sm-3">
                                ...
                                <div class="row m-b-20">
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{asset('admin2/assets/images/mega-menu/01.jpg')}}" alt="Gallery-1">
                                    </div>
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{asset('admin2/assets/images/mega-menu/02.jpg')}}" alt="Gallery-2">
                                    </div>
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{asset('admin2/assets/images/mega-menu/03.jpg')}}" alt="Gallery-3">
                                    </div>
                                </div>
                                <div class="row m-b-20">
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{asset('admin2/assets/images/mega-menu/04.jpg')}}" alt="Gallery-4">
                                    </div>
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{asset('admin2/assets/images/mega-menu/05.jpg')}}" alt="Gallery-5">
                                    </div>
                                    <div class="col-sm-4"><img class="img-fluid img-thumbnail" src="{{asset('admin2/assets/images/mega-menu/06.jpg')}}" alt="Gallery-6">
                                    </div>
                                </div>
                ...
                <ul class="nav-right">
                    ...
                    <li class="header-notification">
                        ...
                        <ul class="show-notification">
                            ...
                            <li>
                                <div class="media">
                                    <img class="d-flex align-self-center" src="{{asset('admin2/assets/images/user.png')}}" alt="Generic placeholder image">
                                    <div class="media-body">
                ...
                <div id="morphsearch" class="morphsearch">
                    ...
                    <div class="morphsearch-content">
                        ...
                        <div class="dummy-column">
                            <h2>Popular</h2>
                            <a class="dummy-media-object" href="#!">
                                <img src="{{asset('admin2/assets/images/avatar-1.png')}}" alt="PagePreloadingEffect" />
                                <h3>Page Preloading Effect</h3>
                            </a>
                            <a class="dummy-media-object" href="#!">
                                <img src="{{asset('admin2/assets/images/avatar-1.png')}}" alt="DraggableDualViewSlideshow" />
                        ...
                        <div class="dummy-column">
                            <h2>Recent</h2>
                            <a class="dummy-media-object" href="#!">
                                <img src="{{asset('admin2/assets/images/avatar-1.png')}}" alt="TooltipStylesInspiration" />
                                <h3>Tooltip Styles Inspiration</h3>
                            </a>
                            <a class="dummy-media-object" href="#!">
                                <img src="{{asset('admin2/assets/images/avatar-1.png')}}" alt="NotificationStyles" />
