...
'additionalPageUrl' => url('/admin/panel/permission/add') ,
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form  action="{{url('/admin/panel/permission/add')}}" method="post" class="form-horizontal"  id="demo-form" data-parsley-validate="">
    ...
    <script  type="text/javascript">
        ...
        $(function() {
            ...
            $('#permission_table').DataTable({
                processing: true,
                serverSide: true,
                ajax: '{{url('/admin/panel/permission/get_datatable')}}',
                columns: [
                    {data: 'id', name: 'id'},
                    {data: 'name', name: 'name'},
        ...
        $(document).ready(function () {
            ...
            $('body').on('click','.edit',function (e) {
                ...
                var html = `<form  action="{{url('admin/panel/permission/update')}}" method="post" class="form-horizontal"  id="formedit" data-parsley-validate="">
