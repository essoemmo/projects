...
'activePageName' => _i('Edit Article'),
                    ...
                    <div class="col-sm-6">
                        <ol class="breadcrumb float-sm-right">
                            <li class="breadcrumb-item">
                                <a href="{{url('/admin/panel/article/all')}}" class="btn btn-default">  <i class="ti-list"></i> {{ _i('All Articles') }}</a>
                            </li>
                        ...
                        <div class="form-group row" >
                            ...
                            <div class="col-sm-6">
                                ...
                                <div class="checkbox-fade fade-in-primary">
                                    <label>
                                        <input type="checkbox" name="published" value="1" {{$article->published == 1 ? 'checked' : ''}}  id="checkbox">
                                        <span class="cr">
