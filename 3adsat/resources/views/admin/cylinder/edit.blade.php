...
'title' => _i('Edit Cylinder '),
'subtitle' => _i('Edit Cylinder '),
'activePageName' => _i('Edit Cylinder'),
...
'form-horizontal']) }} --}}
<form class="form-horizontal" action="{{ route('cylinder.update', ['id' => $cylinder->id]) }}" method="POST" enctype="multipart/form-data" id="editForm" role="form" data-toggle="validator">
    @csrf
    {{ method_field('PUT') }}
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        <div class="card-header">
                            <h5 class="card-title">{{ _i('Edit Cylinder') }}</h5>
                        </div>
                        <!-- /.card-header -->
                        <!-- form start -->
                                            ...
                                            <div class="tab-content">
                                                ...
                                                <div class="tab-pane active" id="tab-general">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control" id="title" name="title" placeholder="{{ _i('title') }}" value="{{ old('model', $cylinder->title) }}" required data-minlength="2">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            @if($cylinder->type == 1)
                                                                <input type="text" class="form-control" id="price" name="price" placeholder="{{ _i('price') }}" value="{{ old('model', $cylinder->price) }}" >
                                                                {!! $errors->first('price','<p class="text-danger"><strong>:message</strong></p>') !!}
                                                            @elseif($cylinder->type == 2)
                                                                <input type="text" class="form-control" readonly id="price" name="price" placeholder="{{ _i('price') }}" value="{{ old('model', $cylinder->price) }}" >
                                                                {!! $errors->first('price','<p class="text-danger"><strong>:message</strong></p>') !!}
                                                            @endif
                                                        </div>
                                                    </div>
