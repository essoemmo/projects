...
'activePageName' => _i('Translation'),
'additionalPageUrl' => url('/admin/panel/translate') ,
...
<div class="box">
    ...
    right: 43%;">
            ...
            <!-- select for language -->
            <div class="col-md-3">
                {{Form::label('language',_i('language'),['class'=>'form-label'])}}
            </div>
            <div class="col-md-5">
    ...
    function initTable() {
        this.table = $('#base_table').DataTable({
            ...
            columns: [{
                ...
                {
                    title: "{{_i('All Records')}}"
                },
                {
                    title: "{{_i('Record Translated')}}",
                ...
                },
                {
                    ...
                    title: "{{_i('Translation')}}",
                    "render": function(data, type, row, meta) {
                        return `<a href="{{url('admin/panel/translation')}}/${row[0]}?lang=${selected_language}" class="btn btn-block btn-info">{{_i('To Translate')}}</a>`;
                    }
                }
            ]
        });
