...
@section('content')
    ...
    <!-- =====Filter Section===== -->
    <div class="box-body" >
        <form action="{{route('content_management.store')}}" method="post" enctype="multipart/form-data" data-parsley-validate="" >
            <?= csrf_field() ?>
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active">
                                        <a href="{{route('content_management.store')}}" >
                         ...
                         <strong><?= $errors->first('order') ?></strong>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-7 {{ $errors->has('title') ? ' has-error' : '' }}">
                                        ...
                                        <input id="title"  name="title"   class="form-control " data-parsley-maxlength="191" value="<?=old('title')?>">
                                        @if ($errors->has('title'))
                                            <span class="text-danger invalid-feedback">
                         <strong><?= $errors->first('title') ?></strong>
                                ...
                                <div class="row">
                                    <div class="col-md-6" >
                                        ...
                                        <textarea id="editor1" class="textarea form-control" name="content[]" required="" data-parsley-minlength="10"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" placeholder="Place write content here...">{{old('content[0]')}}</textarea>
                                    </div>

                                    <div class="col-md-6" style="display:none" id="column2">
                                        <label for="editor2">{{_i('Column2')}} <span style="color: #F00;">*</span></label>
                                        <textarea id="editor2" class="textarea form-control" name="content[]" required="" data-parsley-minlength="10"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" placeholder="Place write content here...">{{old('content[1]')}}</textarea>
                                    </div>

                                    <div class="col-md-6" style="display:none" id="column3">
                                        <label for="editor3" >{{_i('Column3')}} <span style="color: #F00;">*</span></label>
                                        <textarea id="editor3" class="textarea form-control" name="content[]" required="" data-parsley-minlength="10" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" placeholder="Place write content here...">{{old('content[2]')}}</textarea>
                                    </div>

                                    <div class="col-md-6" style="display:none" id="column4">
                                        <label for="editor4">{{_i('Column4')}} <span style="color: #F00;">*</span></label>
                                        <textarea id="editor4" class="textarea form-control" name="content[]" required="" data-parsley-minlength="10"  style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;" placeholder="Place write content here...">{{old('content[3]')}}</textarea>
                                    </div>
                                </div>
                            </div>
                        </div>
