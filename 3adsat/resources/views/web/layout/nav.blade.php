        ...
        <div class="container">
            <div class="row">
                <div class="col-md-2 align-self-center">
                    <div class="logo">
                        <a href=""><img data-src="{{ url('/') }}/web/images/logo.png" src="{{ url('/') }}/web/images/logo.png" class="img-fluid lazy loaded"></a>
                    </div>
                </div>
                <div class="col-md-10 align-self-center">
                            ...
                            <ul class="user-helper d-inline-block list-inline">
                                <li class="lang list-inline-item">
                                    @foreach($langs as $lang)
                                     @if(LaravelGettext::getLocale() != $lang->code)
                                     
                                        <a href="javaScript:void(0)" id="changeLang"  >ddddddd
                                            <input type="hidden" class="lang_code" value="{{ $lang->code }}" name="lang_code">
                                            <img id="lang" src="{{ asset('uploads/languages/' . $lang->id. '/' . $lang->image) }}" alt="">
                                        </a>
                                     @end if
                                    @endforeach
                                </li>
                                ...
                                <li class="list-inline-item dropdown-cart-wrapper">
                                    ...
                                    <div class="shopping-cart " data-simplebar>
                                        <div class="shopping-cart-header">
                                            <i class="fa fa-shopping-cart cart-icon"></i><span class="badge">16</span>
                                        ...
                                        <ul class="shopping-cart-items list-unstyled" id="scrl">
                                            <li class="clearfix">
                                                <img src="{{ url('/') }}/web/images/demo.jpg" alt="item1"/>
                    ...
                    <div class="droopmenu-navbar mt-2">
