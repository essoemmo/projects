    ...
    <div class="user-page common-wrapper" >
        <div class="container">
            <div class="row profile ">
                ...
                @include('web.user.profile_nav' , $user)
                            ...
                            <div class="card-body">
                                <form class=""  action="{{url('/profile')}}" method="post" data-parsley-validate="" id="fileupload"  enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select  class="form-control select2 select2-hidden-accessible" name="country_id" style="width:100%" aria-hidden="true" id="inputCountry" required="" >
