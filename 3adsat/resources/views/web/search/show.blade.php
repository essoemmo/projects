                            ...
                            <div class="add-to-cart">
                                <a href="">
                                    ...
                                    $pricee = \Illuminate\Support\Facades\DB::table('product_price')
                                        ->where('country_id',$country)->where('product_id',$prod4->id)->first();
                                    ...
                                    @if(!empty($pricee->discount))
                                        ...
                                        @if($pricee != null)
                                            <strike class="price">{{$pricee->price}} $</strike>
                                        @endif
                                        <?php
                                        $discou = intval($pricee->price) - intval($prod4->discount);
                                        //                                                dd($discou)
                                        ?>
                                        <span class="price">{{$discou}} $</span>

                                    @else
                                        @if($pricee != null)
                                            <span class="price">{{$pricee->price}} $</span>
                                        @endif
