    ...
    public function dataTable($query)
    {
        return datatables($query)
            ->addColumn('edit', function ($query) {
                return '<a href="transferBank/'.$query->id.'/edit" class="btn btn-success"><i class="fa fa-edit"></i> ' ._i('Edit') .'</a>';
            })
            ->addColumn('logo', function ($query) {
                $url = asset($query->logo);
                return '<img src='.$url.' border="0" width="50px" height="50px" class="img-responsive" align="center" />';
            })
...
//                            ['extend' => 'print','className' => 'btn btn-primary' , 'text' => '<i class="fa fa-print"></i>'],
    ...
    protected function getColumns()
    {
        return [
            ...
            ['name'=>'iban','data'=>'iban','title'=>'iban'],
