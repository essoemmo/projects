    ...
    public function  getDatatablePermission()
    {
        ...
        return DataTables::of($permission)
            ->addColumn('action', function ($permission) {
                return'<button class="btn btn-icon waves-effect waves-light btn-primary edit text-center" data-id ="'.$permission->id.'" data-name ="'.$permission->name.'" data-toggle="modal" data-target="#edit"  title="'._i("Edit").'"><i class="ti-pencil-alt"></i> </button>' ."&nbsp;&nbsp;&nbsp;".
                    '<a href="'.$permission->id.'/delete" class="btn btn-icon waves-effect waves-light btn btn-danger text-center" title="'._i("Delete").'"><i class="ti-trash center"></i> </a>';
            })
            ->make(true);
    }
...
//        dd(Admin::where('id','=',Auth::guard('admin')->user()->id)->first()->hasPermissionTo('Add-Permission', 'admin'));
    ...
    public function updatePermission(Request $request)
    {
        ...
        return redirect('/admin/panel/permission/all')->withFlashMessage(_i('Updated Successfully !'));
    }
    ...
    public function deletePermission($id)
    {
        ...
        return redirect('/admin/panel/permission/all')
