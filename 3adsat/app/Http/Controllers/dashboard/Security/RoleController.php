    ...
    public function  getDatatableRoles()
    {
        ...
        return DataTables::of($role)
            ->addColumn('action', function ($role) {
                return'<a href="'.$role->id.'/edit" class="btn btn-icon waves-effect waves-light btn-primary text-center" title="'._i("Edit").'"><i class="ti-pencil-alt"></i> </a>' ."&nbsp;&nbsp;&nbsp;".
                    '<a href="'.$role->id.'/delete" class="btn btn-icon waves-effect waves-light btn-danger text-center" title="'._i("Delete").'"><i class="ti-trash"></i> </a>';
            })
            ->make(true);
    }
...
//        dd($users);
        ...
        return redirect('/admin/panel/role/'.$role->id.'/edit')->withFlashMessage(_i('Updated Successfully !'));
    }
    ...
    public function deleteRole($id)
    {
        ...
        return redirect('/admin/panel/role/all')->withFlashMessage(_i('Deleted Successfully !'));
